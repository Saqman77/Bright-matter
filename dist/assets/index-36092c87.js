...
void main() {
	...
	#include <fog_fragment>
		...
		`,blending:er,depthTest:!1,depthWrite:!1})}function wh(){return new Gr({name:"CubemapToCubeUV",uniforms:{envMap:{value:null},flipEnvMap:{value:-1}},vertexShader:Yc(),fragmentShader:`
...
*/var jt,Ta,Bn,Ki,Zi,ys,ld,Mr,oo,cd,Ni,si,ud,hd=function(){return jt||typeof window<"u"&&(jt=window.gsap)&&jt.registerPlugin&&jt},fd=1,gs=[],tt=[],xi=[],ao=Date.now,vc=function(e,t){return t},sS=function(){var e=oo.core,t=e.bridge||{},n=e._scrollers,i=e._proxies;n.push.apply(n,tt),i.push.apply(i,xi),tt=n,xi=i,vc=function(a,o){return t[a](o)}},ir=function(e,t){return~xi.indexOf(e)&&xi[xi.indexOf(e)+1][t]},lo=function(e){return!!~cd.indexOf(e)},cn=function(e,t,n,i,s){return e.addEventListener(t,n,{passive:i!==!1,capture:!!s})},ln=function(e,t,n,i){return e.removeEventListener(t,n,!!i)},ua="scrollLeft",ha="scrollTop",xc=function(){return Ni&&Ni.isPressed||tt.cache++},ka=function(e,t){var n=function i(s){if(s||s===0){fd&&(Bn.history.scrollRestoration="manual");var a=Ni&&Ni.isPressed;s=i.v=Math.round(s)||(Ni&&Ni.iOS?1:0),e(s),i.cacheID=tt.cache,a&&vc("ss",s)}else(t||tt.cache!==i.cacheID||vc("ref"))&&(i.cacheID=tt.cache,i.v=e());return i.v+i.offset};return n.offset=0,e&&n},_n={s:ua,p:"left",p2:"Left",os:"right",os2:"Right",d:"width",d2:"Width",a:"x",sc:ka(function(r){return arguments.length?Bn.scrollTo(r,Bt.sc()):Bn.pageXOffset||Ki[ua]||Zi[ua]||ys[ua]||0})},Bt={s:ha,p:"top",p2:"Top",os:"bottom",os2:"Bottom",d:"height",d2:"Height",a:"y",op:_n,sc:ka(function(r){return arguments.length?Bn.scrollTo(_n.sc(),r):Bn.pageYOffset||Ki[ha]||Zi[ha]||ys[ha]||0})},Sn=function(e,t){return(t&&t._ctx&&t._ctx.selector||jt.utils.toArray)(e)[0]||(typeof e=="string"&&jt.config().nullTargetWarn!==!1?console.warn("Element not found:",e):null)},ar=function(e,t){var n=t.s,i=t.sc;lo(e)&&(e=Ki.scrollingElement||Zi);var s=tt.indexOf(e),a=i===Bt.sc?1:2;!~s&&(s=tt.push(e)-1),tt[s+a]||cn(e,"scroll",xc);var o=tt[s+a],l=o||(tt[s+a]=ka(ir(e,n),!0)||(lo(e)?i:ka(function(c){return arguments.length?e[n]=c:e[n]})));return l.target=e,o||(l.smooth=jt.getProperty(e,"scrollBehavior")==="smooth"),l},Sc=function(e,t,n){var i=e,s=e,a=ao(),o=a,l=t||50,c=Math.max(500,l*3),u=function(g,_){var m=ao();_||m-a>l?(s=i,i=g,o=a,a=m):n?i+=g:i=s+(g-s)/(m-o)*(a-o)},h=function(){s=i=n?0:i,o=a=0},f=function(g){var _=o,m=s,p=ao();return(g||g===0)&&g!==i&&u(g),a===o||p-o>c?0:(i+(n?m:-m))/((n?p:a)-_)*1e3};return{update:u,reset:h,getVelocity:f}},qs=function(e,t){return t&&!e._gsapAllow&&e.preventDefault(),e.changedTouches?e.changedTouches[0]:e},Yh=function(e){var t=Math.max.apply(Math,e),n=Math.min.apply(Math,e);return Math.abs(t)>=Math.abs(n)?t:n},dd=function(){oo=jt.core.globals().ScrollTrigger,oo&&oo.core&&sS()},pd=function(e){return jt=e||hd(),!Ta&&jt&&typeof document<"u"&&document.body&&(Bn=window,Ki=document,Zi=Ki.documentElement,ys=Ki.body,cd=[Bn,Ki,Zi,ys],jt.utils.clamp,ud=jt.core.context||function(){},Mr="onpointerenter"in ys?"pointer":"mouse",ld=Lt.isTouch=Bn.matchMedia&&Bn.matchMedia("(hover: none), (pointer: coarse)").matches?1:"ontouchstart"in Bn||navigator.maxTouchPoints>0||navigator.msMaxTouchPoints>0?2:0,si=Lt.eventTypes=("ontouchstart"in Zi?"touchstart,touchmove,touchcancel,touchend":"onpointerdown"in Zi?"pointerdown,pointermove,pointercancel,pointerup":"mousedown,mousemove,mouseup,mouseup").split(","),setTimeout(function(){return fd=0},500),dd(),Ta=1),Ta};_n.op=Bt;tt.cache=0;var Lt=function(){function r(t){this.init(t)}var e=r.prototype;return e.init=function(n){Ta||pd(jt)||console.warn("Please gsap.registerPlugin(Observer)"),oo||dd();var i=n.tolerance,s=n.dragMinimum,a=n.type,o=n.target,l=n.lineHeight,c=n.debounce,u=n.preventDefault,h=n.onStop,f=n.onStopDelay,d=n.ignore,g=n.wheelSpeed,_=n.event,m=n.onDragStart,p=n.onDragEnd,M=n.onDrag,v=n.onPress,S=n.onRelease,E=n.onRight,A=n.onLeft,w=n.onUp,D=n.onDown,x=n.onChangeX,b=n.onChangeY,F=n.onChange,N=n.onToggleX,Z=n.onToggleY,P=n.onHover,z=n.onHoverEnd,q=n.onMove,O=n.ignoreCheck,j=n.isNormalizer,Y=n.onGestureStart,R=n.onGestureEnd,U=n.onWheel,$=n.onEnable,ue=n.onDisable,oe=n.onClick,he=n.scrollSpeed,ye=n.capture,Le=n.allowClicks,Ee=n.lockAxis,Ce=n.onLockAxis;this.target=o=Sn(o)||Zi,this.vars=n,d&&(d=jt.utils.toArray(d)),i=i||1e-9,s=s||0,g=g||1,he=he||1,a=a||"wheel,touch,pointer",c=c!==!1,l||(l=parseFloat(Bn.getComputedStyle(ys).lineHeight)||22);var at,De,k,He,pe,be,we,G=this,ze=0,ke=0,nt=n.passive||!u,Ke=ar(o,_n),xt=ar(o,Bt),C=Ke(),y=xt(),B=~a.indexOf("touch")&&!~a.indexOf("pointer")&&si[0]==="pointerdown",ie=lo(o),J=o.ownerDocument||Ki,ee=[0,0,0],me=[0,0,0],re=0,de=function(){return re=ao()},_e=function(Se,Re){return(G.event=Se)&&d&&~d.indexOf(Se.target)||Re&&B&&Se.pointerType!=="touch"||O&&O(Se,Re)},it=function(){G._vx.reset(),G._vy.reset(),De.pause(),h&&h(G)},ne=function(){var Se=G.deltaX=Yh(ee),Re=G.deltaY=Yh(me),se=Math.abs(Se)>=i,Ne=Math.abs(Re)>=i;F&&(se||Ne)&&F(G,Se,Re,ee,me),se&&(E&&G.deltaX>0&&E(G),A&&G.deltaX<0&&A(G),x&&x(G),N&&G.deltaX<0!=ze<0&&N(G),ze=G.deltaX,ee[0]=ee[1]=ee[2]=0),Ne&&(D&&G.deltaY>0&&D(G),w&&G.deltaY<0&&w(G),b&&b(G),Z&&G.deltaY<0!=ke<0&&Z(G),ke=G.deltaY,me[0]=me[1]=me[2]=0),(He||k)&&(q&&q(G),k&&(M(G),k=!1),He=!1),be&&!(be=!1)&&Ce&&Ce(G),pe&&(U(G),pe=!1),at=0},rt=function(Se,Re,se){ee[se]+=Se,me[se]+=Re,G._vx.update(Se),G._vy.update(Re),c?at||(at=requestAnimationFrame(ne)):ne()},Be=function(Se,Re){Ee&&!we&&(G.axis=we=Math.abs(Se)>Math.abs(Re)?"x":"y",be=!0),we!=="y"&&(ee[2]+=Se,G._vx.update(Se,!0)),we!=="x"&&(me[2]+=Re,G._vy.update(Re,!0)),c?at||(at=requestAnimationFrame(ne)):ne()},Ue=function(Se){if(!_e(Se,1)){Se=qs(Se,u);var Re=Se.clientX,se=Se.clientY,Ne=Re-G.x,Ie=se-G.y,Ve=G.isDragging;G.x=Re,G.y=se,(Ve||Math.abs(G.startX-Re)>=s||Math.abs(G.startY-se)>=s)&&(M&&(k=!0),Ve||(G.isDragging=!0),Be(Ne,Ie),Ve||m&&m(G))}},Pe=G.onPress=function(ve){_e(ve,1)||ve&&ve.button||(G.axis=we=null,De.pause(),G.isPressed=!0,ve=qs(ve),ze=ke=0,G.startX=G.x=ve.clientX,G.startY=G.y=ve.clientY,G._vx.reset(),G._vy.reset(),cn(j?o:J,si[1],Ue,nt,!0),G.deltaX=G.deltaY=0,v&&v(G))},Q=G.onRelease=function(ve){if(!_e(ve,1)){ln(j?o:J,si[1],Ue,!0);var Se=!isNaN(G.y-G.startY),Re=G.isDragging,se=Re&&(Math.abs(G.x-G.startX)>3||Math.abs(G.y-G.startY)>3),Ne=qs(ve);!se&&Se&&(G._vx.reset(),G._vy.reset(),u&&Le&&jt.delayedCall(.08,function(){if(ao()-re>300&&!ve.defaultPrevented){if(ve.target.click)ve.target.click();else if(J.createEvent){var Ie=J.createEvent("MouseEvents");Ie.initMouseEvent("click",!0,!0,Bn,1,Ne.screenX,Ne.screenY,Ne.clientX,Ne.clientY,!1,!1,!1,!1,0,null),ve.target.dispatchEvent(Ie)}}})),G.isDragging=G.isGesturing=G.isPressed=!1,h&&Re&&!j&&De.restart(!0),p&&Re&&p(G),S&&S(G,se)}},Xe=function(Se){return Se.touches&&Se.touches.length>1&&(G.isGesturing=!0)&&Y(Se,G.isDragging)},L=function(){return(G.isGesturing=!1)||R(G)},ce=function(Se){if(!_e(Se)){var Re=Ke(),se=xt();rt((Re-C)*he,(se-y)*he,1),C=Re,y=se,h&&De.restart(!0)}},te=function(Se){if(!_e(Se)){Se=qs(Se,u),U&&(pe=!0);var Re=(Se.deltaMode===1?l:Se.deltaMode===2?Bn.innerHeight:1)*g;rt(Se.deltaX*Re,Se.deltaY*Re,0),h&&!j&&De.restart(!0)}},K=function(Se){if(!_e(Se)){var Re=Se.clientX,se=Se.clientY,Ne=Re-G.x,Ie=se-G.y;G.x=Re,G.y=se,He=!0,h&&De.restart(!0),(Ne||Ie)&&Be(Ne,Ie)}},ae=function(Se){G.event=Se,P(G)},Ae=function(Se){G.event=Se,z(G)},et=function(Se){return _e(Se)||qs(Se,u)&&oe(G)};De=G._dc=jt.delayedCall(f||.25,it).pause(),G.deltaX=G.deltaY=0,G._vx=Sc(0,50,!0),G._vy=Sc(0,50,!0),G.scrollX=Ke,G.scrollY=xt,G.isDragging=G.isGesturing=G.isPressed=!1,ud(this),G.enable=function(ve){return G.isEnabled||(cn(ie?J:o,"scroll",xc),a.indexOf("scroll")>=0&&cn(ie?J:o,"scroll",ce,nt,ye),a.indexOf("wheel")>=0&&cn(o,"wheel",te,nt,ye),(a.indexOf("touch")>=0&&ld||a.indexOf("pointer")>=0)&&(cn(o,si[0],Pe,nt,ye),cn(J,si[2],Q),cn(J,si[3],Q),Le&&cn(o,"click",de,!0,!0),oe&&cn(o,"click",et),Y&&cn(J,"gesturestart",Xe),R&&cn(J,"gestureend",L),P&&cn(o,Mr+"enter",ae),z&&cn(o,Mr+"leave",Ae),q&&cn(o,Mr+"move",K)),G.isEnabled=!0,ve&&ve.type&&Pe(ve),$&&$(G)),G},G.disable=function(){G.isEnabled&&(gs.filter(function(ve){return ve!==G&&lo(ve.target)}).length||ln(ie?J:o,"scroll",xc),G.isPressed&&(G._vx.reset(),G._vy.reset(),ln(j?o:J,si[1],Ue,!0)),ln(ie?J:o,"scroll",ce,ye),ln(o,"wheel",te,ye),ln(o,si[0],Pe,ye),ln(J,si[2],Q),ln(J,si[3],Q),ln(o,"click",de,!0),ln(o,"click",et),ln(J,"gesturestart",Xe),ln(J,"gestureend",L),ln(o,Mr+"enter",ae),ln(o,Mr+"leave",Ae),ln(o,Mr+"move",K),G.isEnabled=G.isPressed=G.isDragging=!1,ue&&ue(G))},G.kill=G.revert=function(){G.disable();var ve=gs.indexOf(G);ve>=0&&gs.splice(ve,1),Ni===G&&(Ni=0)},gs.push(G),j&&lo(o)&&(Ni=G),G.enable(_)},rS(r,[{key:"velocityX",get:function(){return this._vx.getVelocity()}},{key:"velocityY",get:function(){return this._vy.getVelocity()}}]),r}();Lt.version="3.12.5";Lt.create=function(r){return new Lt(r)};Lt.register=pd;Lt.getAll=function(){return gs.slice()};Lt.getById=function(r){return gs.filter(function(e){return e.vars.id===r})[0]};hd()&&jt.registerPlugin(Lt);/*!
 ...
 * Club GSAP members, the agreement issued with that membership.
 * @author: Jack Doyle, jack@greensock.com
*/var Vn={autoSleep:120,force3D:"auto",nullTargetWarn:1,units:{lineHeight:""}},Us={duration:.5,overwrite:!1,delay:0},iu,rn,Tt,jn=1e8,vt=1/jn,Rc=Math.PI*2,bS=Rc/4,wS=0,Od=Math.sqrt,AS=Math.cos,RS=Math.sin,$t=function(e){return typeof e=="string"},Ct=function(e){return typeof e=="function"},zi=function(e){return typeof e=="number"},ru=function(e){return typeof e>"u"},Mi=function(e){return typeof e=="object"},bn=function(e){return e!==!1},su=function(){return typeof window<"u"},ya=function(e){return Ct(e)||$t(e)},Fd=typeof ArrayBuffer=="function"&&ArrayBuffer.isView||function(){},sn=Array.isArray,Cc=/(?:-?\.?\d|\.)+/gi,zd=/[-+=.]*\d+[.e\-+]*\d*[e\-+]*\d*/g,vs=/[-+=.]*\d+[.e-]*\d*[a-z%]*/g,Zl=/[-+=.]*\d+\.?\d*(?:e-|e\+)?\d*/gi,Bd=/[+-]=-?[.\d]+/,kd=/[^,'"\[\]\s]+/gi,CS=/^[+\-=e\s\d]*\d+[.\d]*([a-z]*|%)\s*$/i,At,pi,Pc,ou,Wn={},Xa={},Hd,Gd=function(e){return(Xa=qr(e,Wn))&&Cn},au=function(e,t){return console.warn("Invalid property",e,"set to",t,"Missing plugin? gsap.registerPlugin()")},bo=function(e,t){return!t&&console.warn(e)},Vd=function(e,t){return e&&(Wn[e]=t)&&Xa&&(Xa[e]=t)||Wn},wo=function(){return 0},PS={suppressEvents:!0,isStart:!0,kill:!1},Pa={suppressEvents:!0,kill:!1},LS={suppressEvents:!0},lu={},rr=[],Lc={},Wd,Fn={},jl={},df=30,La=[],cu="",uu=function(e){var t=e[0],n,i;if(Mi(t)||Ct(t)||(e=[e]),!(n=(t._gsap||{}).harness)){for(i=La.length;i--&&!La[i].targetTest(t););n=La[i]}for(i=e.length;i--;)e[i]&&(e[i]._gsap||(e[i]._gsap=new pp(e[i],n)))||e.splice(i,1);return e},Or=function(e){return e._gsap||uu(Jn(e))[0]._gsap},Xd=function(e,t,n){return(n=e[t])&&Ct(n)?e[t]():ru(n)&&e.getAttribute&&e.getAttribute(t)||n},wn=function(e,t){return(e=e.split(",")).forEach(t)||e},Pt=function(e){return Math.round(e*1e5)/1e5||0},qt=function(e){return Math.round(e*1e7)/1e7||0},bs=function(e,t){var n=t.charAt(0),i=parseFloat(t.substr(2));return e=parseFloat(e),n==="+"?e+i:n==="-"?e-i:n==="*"?e*i:e/i},DS=function(e,t){for(var n=t.length,i=0;e.indexOf(t[i])<0&&++i<n;);return i<n},qa=function(){var e=rr.length,t=rr.slice(0),n,i;for(Lc={},rr.length=0,n=0;n<e;n++)i=t[n],i&&i._lazy&&(i.render(i._lazy[0],i._lazy[1],!0)._lazy=0)},qd=function(e,t,n,i){rr.length&&!rn&&qa(),e.render(t,n,i||rn&&t<0&&(e._initted||e._startAt)),rr.length&&!rn&&qa()},Yd=function(e){var t=parseFloat(e);return(t||t===0)&&(e+"").match(kd).length<2?t:$t(e)?e.trim():e},$d=function(e){return e},ei=function(e,t){for(var n in t)n in e||(e[n]=t[n]);return e},US=function(e){return function(t,n){for(var i in n)i in t||i==="duration"&&e||i==="ease"||(t[i]=n[i])}},qr=function(e,t){for(var n in t)e[n]=t[n];return e},pf=function r(e,t){for(var n in t)n!=="__proto__"&&n!=="constructor"&&n!=="prototype"&&(e[n]=Mi(t[n])?r(e[n]||(e[n]={}),t[n]):t[n]);return e},Ya=function(e,t){var n={},i;for(i in e)i in t||(n[i]=e[i]);return n},_o=function(e){var t=e.parent||At,n=e.keyframes?US(sn(e.keyframes)):ei;if(bn(e.inherit))for(;t;)n(e,t.vars.defaults),t=t.parent||t._dp;return e},IS=function(e,t){for(var n=e.length,i=n===t.length;i&&n--&&e[n]===t[n];);return n<0},Kd=function(e,t,n,i,s){n===void 0&&(n="_first"),i===void 0&&(i="_last");var a=e[i],o;if(s)for(o=t[s];a&&a[s]>o;)a=a._prev;return a?(t._next=a._next,a._next=t):(t._next=e[n],e[n]=t),t._next?t._next._prev=t:e[i]=t,t._prev=a,t.parent=t._dp=e,t},sl=function(e,t,n,i){n===void 0&&(n="_first"),i===void 0&&(i="_last");var s=t._prev,a=t._next;s?s._next=a:e[n]===t&&(e[n]=a),a?a._prev=s:e[i]===t&&(e[i]=s),t._next=t._prev=t.parent=null},lr=function(e,t){e.parent&&(!t||e.parent.autoRemoveChildren)&&e.parent.remove&&e.parent.remove(e),e._act=0},Fr=function(e,t){if(e&&(!t||t._end>e._dur||t._start<0))for(var n=e;n;)n._dirty=1,n=n.parent;return e},NS=function(e){for(var t=e.parent;t&&t.parent;)t._dirty=1,t.totalDuration(),t=t.parent;return e},Dc=function(e,t,n,i){return e._startAt&&(rn?e._startAt.revert(Pa):e.vars.immediateRender&&!e.vars.autoRevert||e._startAt.render(t,!0,i))},OS=function r(e){return!e||e._ts&&r(e.parent)},mf=function(e){return e._repeat?Is(e._tTime,e=e.duration()+e._rDelay)*e:0},Is=function(e,t){var n=Math.floor(e/=t);return e&&n===e?n-1:n},$a=function(e,t){return(e-t._start)*t._ts+(t._ts>=0?0:t._dirty?t.totalDuration():t._tDur)},ol=function(e){return e._end=qt(e._start+(e._tDur/Math.abs(e._ts||e._rts||vt)||0))},al=function(e,t){var n=e._dp;return n&&n.smoothChildTiming&&e._ts&&(e._start=qt(n._time-(e._ts>0?t/e._ts:((e._dirty?e.totalDuration():e._tDur)-t)/-e._ts)),ol(e),n._dirty||Fr(n,e)),e},Zd=function(e,t){var n;if((t._time||!t._dur&&t._initted||t._start<e._time&&(t._dur||!t.add))&&(n=$a(e.rawTime(),t),(!t._dur||Bo(0,t.totalDuration(),n)-t._tTime>vt)&&t.render(n,!0)),Fr(e,t)._dp&&e._initted&&e._time>=e._dur&&e._ts){if(e._dur<e.duration())for(n=e;n._dp;)n.rawTime()>=0&&n.totalTime(n._tTime),n=n._dp;e._zTime=-vt}},_i=function(e,t,n,i){return t.parent&&lr(t),t._start=qt((zi(n)?n:n||e!==At?qn(e,n,t):e._time)+t._delay),t._end=qt(t._start+(t.totalDuration()/Math.abs(t.timeScale())||0)),Kd(e,t,"_first","_last",e._sort?"_start":0),Uc(t)||(e._recent=t),i||Zd(e,t),e._ts<0&&al(e,e._tTime),e},jd=function(e,t){return(Wn.ScrollTrigger||au("scrollTrigger",t))&&Wn.ScrollTrigger.create(t,e)},Jd=function(e,t,n,i,s){if(fu(e,t,s),!e._initted)return 1;if(!n&&e._pt&&!rn&&(e._dur&&e.vars.lazy!==!1||!e._dur&&e.vars.lazy)&&Wd!==kn.frame)return rr.push(e),e._lazy=[s,i],1},FS=function r(e){var t=e.parent;return t&&t._ts&&t._initted&&!t._lock&&(t.rawTime()<0||r(t))},Uc=function(e){var t=e.data;return t==="isFromStart"||t==="isStart"},zS=function(e,t,n,i){var s=e.ratio,a=t<0||!t&&(!e._start&&FS(e)&&!(!e._initted&&Uc(e))||(e._ts<0||e._dp._ts<0)&&!Uc(e))?0:1,o=e._rDelay,l=0,c,u,h;if(o&&e._repeat&&(l=Bo(0,e._tDur,t),u=Is(l,o),e._yoyo&&u&1&&(a=1-a),u!==Is(e._tTime,o)&&(s=1-a,e.vars.repeatRefresh&&e._initted&&e.invalidate())),a!==s||rn||i||e._zTime===vt||!t&&e._zTime){if(!e._initted&&Jd(e,t,i,n,l))return;for(h=e._zTime,e._zTime=t||(n?vt:0),n||(n=t&&!h),e.ratio=a,e._from&&(a=1-a),e._time=0,e._tTime=l,c=e._pt;c;)c.r(a,c.d),c=c._next;t<0&&Dc(e,t,n,!0),e._onUpdate&&!n&&Hn(e,"onUpdate"),l&&e._repeat&&!n&&e.parent&&Hn(e,"onRepeat"),(t>=e._tDur||t<0)&&e.ratio===a&&(a&&lr(e,1),!n&&!rn&&(Hn(e,a?"onComplete":"onReverseComplete",!0),e._prom&&e._prom()))}else e._zTime||(e._zTime=t)},BS=function(e,t,n){var i;if(n>t)for(i=e._first;i&&i._start<=n;){if(i.data==="isPause"&&i._start>t)return i;i=i._next}else for(i=e._last;i&&i._start>=n;){if(i.data==="isPause"&&i._start<t)return i;i=i._prev}},Ns=function(e,t,n,i){var s=e._repeat,a=qt(t)||0,o=e._tTime/e._tDur;return o&&!i&&(e._time*=a/e._dur),e._dur=a,e._tDur=s?s<0?1e10:qt(a*(s+1)+e._rDelay*s):a,o>0&&!i&&al(e,e._tTime=e._tDur*o),e.parent&&ol(e),n||Fr(e.parent,e),e},_f=function(e){return e instanceof vn?Fr(e):Ns(e,e._dur)},kS={_start:0,endTime:wo,totalDuration:wo},qn=function r(e,t,n){var i=e.labels,s=e._recent||kS,a=e.duration()>=jn?s.endTime(!1):e._dur,o,l,c;return $t(t)&&(isNaN(t)||t in i)?(l=t.charAt(0),c=t.substr(-1)==="%",o=t.indexOf("="),l==="<"||l===">"?(o>=0&&(t=t.replace(/=/,"")),(l==="<"?s._start:s.endTime(s._repeat>=0))+(parseFloat(t.substr(1))||0)*(c?(o<0?s:n).totalDuration()/100:1)):o<0?(t in i||(i[t]=a),i[t]):(l=parseFloat(t.charAt(o-1)+t.substr(o+1)),c&&n&&(l=l/100*(sn(n)?n[0]:n).totalDuration()),o>1?r(e,t.substr(0,o-1),n)+l:a+l)):t==null?a:+t},go=function(e,t,n){var i=zi(t[1]),s=(i?2:1)+(e<2?0:1),a=t[s],o,l;if(i&&(a.duration=t[1]),a.parent=n,e){for(o=a,l=n;l&&!("immediateRender"in o);)o=l.vars.defaults||{},l=bn(l.vars.inherit)&&l.parent;a.immediateRender=bn(o.immediateRender),e<2?a.runBackwards=1:a.startAt=t[s-1]}return new Nt(t[0],a,t[s+1])},ur=function(e,t){return e||e===0?t(e):t},Bo=function(e,t,n){return n<e?e:n>t?t:n},nn=function(e,t){return!$t(e)||!(t=CS.exec(e))?"":t[1]},HS=function(e,t,n){return ur(n,function(i){return Bo(e,t,i)})},Ic=[].slice,Qd=function(e,t){return e&&Mi(e)&&"length"in e&&(!t&&!e.length||e.length-1 in e&&Mi(e[0]))&&!e.nodeType&&e!==pi},GS=function(e,t,n){return n===void 0&&(n=[]),e.forEach(function(i){var s;return $t(i)&&!t||Qd(i,1)?(s=n).push.apply(s,Jn(i)):n.push(i)})||n},Jn=function(e,t,n){return Tt&&!t&&Tt.selector?Tt.selector(e):$t(e)&&!n&&(Pc||!Os())?Ic.call((t||ou).querySelectorAll(e),0):sn(e)?GS(e,n):Qd(e)?Ic.call(e,0):e?[e]:[]},Nc=function(e){return e=Jn(e)[0]||bo("Invalid scope")||{},function(t){var n=e.current||e.nativeElement||e;return Jn(t,n.querySelectorAll?n:n===e?bo("Invalid scope")||ou.createElement("div"):e)}},ep=function(e){return e.sort(function(){return .5-Math.random()})},tp=function(e){if(Ct(e))return e;var t=Mi(e)?e:{each:e},n=zr(t.ease),i=t.from||0,s=parseFloat(t.base)||0,a={},o=i>0&&i<1,l=isNaN(i)||o,c=t.axis,u=i,h=i;return $t(i)?u=h={center:.5,edges:.5,end:1}[i]||0:!o&&l&&(u=i[0],h=i[1]),function(f,d,g){var _=(g||t).length,m=a[_],p,M,v,S,E,A,w,D,x;if(!m){if(x=t.grid==="auto"?0:(t.grid||[1,jn])[1],!x){for(w=-jn;w<(w=g[x++].getBoundingClientRect().left)&&x<_;);x<_&&x--}for(m=a[_]=[],p=l?Math.min(x,_)*u-.5:i%x,M=x===jn?0:l?_*h/x-.5:i/x|0,w=0,D=jn,A=0;A<_;A++)v=A%x-p,S=M-(A/x|0),m[A]=E=c?Math.abs(c==="y"?S:v):Od(v*v+S*S),E>w&&(w=E),E<D&&(D=E);i==="random"&&ep(m),m.max=w-D,m.min=D,m.v=_=(parseFloat(t.amount)||parseFloat(t.each)*(x>_?_-1:c?c==="y"?_/x:x:Math.max(x,_/x))||0)*(i==="edges"?-1:1),m.b=_<0?s-_:s,m.u=nn(t.amount||t.each)||0,n=n&&_<0?hp(n):n}return _=(m[f]-m.min)/m.max||0,qt(m.b+(n?n(_):_)*m.v)+m.u}},Oc=function(e){var t=Math.pow(10,((e+"").split(".")[1]||"").length);return function(n){var i=qt(Math.round(parseFloat(n)/e)*e*t);return(i-i%1)/t+(zi(n)?0:nn(n))}},np=function(e,t){var n=sn(e),i,s;return!n&&Mi(e)&&(i=n=e.radius||jn,e.values?(e=Jn(e.values),(s=!zi(e[0]))&&(i*=i)):e=Oc(e.increment)),ur(t,n?Ct(e)?function(a){return s=e(a),Math.abs(s-a)<=i?s:a}:function(a){for(var o=parseFloat(s?a.x:a),l=parseFloat(s?a.y:0),c=jn,u=0,h=e.length,f,d;h--;)s?(f=e[h].x-o,d=e[h].y-l,f=f*f+d*d):f=Math.abs(e[h]-o),f<c&&(c=f,u=h);return u=!i||c<=i?e[u]:a,s||u===a||zi(a)?u:u+nn(a)}:Oc(e))},ip=function(e,t,n,i){return ur(sn(e)?!t:n===!0?!!(n=0):!i,function(){return sn(e)?e[~~(Math.random()*e.length)]:(n=n||1e-5)&&(i=n<1?Math.pow(10,(n+"").length-2):1)&&Math.floor(Math.round((e-n/2+Math.random()*(t-e+n*.99))/n)*n*i)/i})},VS=function(){for(var e=arguments.length,t=new Array(e),n=0;n<e;n++)t[n]=arguments[n];return function(i){return t.reduce(function(s,a){return a(s)},i)}},WS=function(e,t){return function(n){return e(parseFloat(n))+(t||nn(n))}},XS=function(e,t,n){return sp(e,t,0,1,n)},rp=function(e,t,n){return ur(n,function(i){return e[~~t(i)]})},qS=function r(e,t,n){var i=t-e;return sn(e)?rp(e,r(0,e.length),t):ur(n,function(s){return(i+(s-e)%i)%i+e})},YS=function r(e,t,n){var i=t-e,s=i*2;return sn(e)?rp(e,r(0,e.length-1),t):ur(n,function(a){return a=(s+(a-e)%s)%s||0,e+(a>i?s-a:a)})},Ao=function(e){for(var t=0,n="",i,s,a,o;~(i=e.indexOf("random(",t));)a=e.indexOf(")",i),o=e.charAt(i+7)==="[",s=e.substr(i+7,a-i-7).match(o?kd:Cc),n+=e.substr(t,i-t)+ip(o?s:+s[0],o?0:+s[1],+s[2]||1e-5),t=a+1;return n+e.substr(t,e.length-t)},sp=function(e,t,n,i,s){var a=t-e,o=i-n;return ur(s,function(l){return n+((l-e)/a*o||0)})},$S=function r(e,t,n,i){var s=isNaN(e+t)?0:function(d){return(1-d)*e+d*t};if(!s){var a=$t(e),o={},l,c,u,h,f;if(n===!0&&(i=1)&&(n=null),a)e={p:e},t={p:t};else if(sn(e)&&!sn(t)){for(u=[],h=e.length,f=h-2,c=1;c<h;c++)u.push(r(e[c-1],e[c]));h--,s=function(g){g*=h;var _=Math.min(f,~~g);return u[_](g-_)},n=t}else i||(e=qr(sn(e)?[]:{},e));if(!u){for(l in t)hu.call(o,e,l,"get",t[l]);s=function(g){return mu(g,o)||(a?e.p:e)}}}return ur(n,s)},gf=function(e,t,n){var i=e.labels,s=jn,a,o,l;for(a in i)o=i[a]-t,o<0==!!n&&o&&s>(o=Math.abs(o))&&(l=a,s=o);return l},Hn=function(e,t,n){var i=e.vars,s=i[t],a=Tt,o=e._ctx,l,c,u;if(s)return l=i[t+"Params"],c=i.callbackScope||e,n&&rr.length&&qa(),o&&(Tt=o),u=l?s.apply(c,l):s.call(c),Tt=a,u},no=function(e){return lr(e),e.scrollTrigger&&e.scrollTrigger.kill(!!rn),e.progress()<1&&Hn(e,"onInterrupt"),e},xs,op=[],ap=function(e){if(e)if(e=!e.name&&e.default||e,su()||e.headless){var t=e.name,n=Ct(e),i=t&&!n&&e.init?function(){this._props=[]}:e,s={init:wo,render:mu,add:hu,kill:uM,modifier:cM,rawVars:0},a={targetTest:0,get:0,getSetter:pu,aliases:{},register:0};if(Os(),e!==i){if(Fn[t])return;ei(i,ei(Ya(e,s),a)),qr(i.prototype,qr(s,Ya(e,a))),Fn[i.prop=t]=i,e.targetTest&&(La.push(i),lu[t]=1),t=(t==="css"?"CSS":t.charAt(0).toUpperCase()+t.substr(1))+"Plugin"}Vd(t,i),e.register&&e.register(Cn,i,An)}else op.push(e)},pt=255,io={aqua:[0,pt,pt],lime:[0,pt,0],silver:[192,192,192],black:[0,0,0],maroon:[128,0,0],teal:[0,128,128],blue:[0,0,pt],navy:[0,0,128],white:[pt,pt,pt],olive:[128,128,0],yellow:[pt,pt,0],orange:[pt,165,0],gray:[128,128,128],purple:[128,0,128],green:[0,128,0],red:[pt,0,0],pink:[pt,192,203],cyan:[0,pt,pt],transparent:[pt,pt,pt,0]},Jl=function(e,t,n){return e+=e<0?1:e>1?-1:0,(e*6<1?t+(n-t)*e*6:e<.5?n:e*3<2?t+(n-t)*(2/3-e)*6:t)*pt+.5|0},lp=function(e,t,n){var i=e?zi(e)?[e>>16,e>>8&pt,e&pt]:0:io.black,s,a,o,l,c,u,h,f,d,g;if(!i){if(e.substr(-1)===","&&(e=e.substr(0,e.length-1)),io[e])i=io[e];else if(e.charAt(0)==="#"){if(e.length<6&&(s=e.charAt(1),a=e.charAt(2),o=e.charAt(3),e="#"+s+s+a+a+o+o+(e.length===5?e.charAt(4)+e.charAt(4):"")),e.length===9)return i=parseInt(e.substr(1,6),16),[i>>16,i>>8&pt,i&pt,parseInt(e.substr(7),16)/255];e=parseInt(e.substr(1),16),i=[e>>16,e>>8&pt,e&pt]}else if(e.substr(0,3)==="hsl"){if(i=g=e.match(Cc),!t)l=+i[0]%360/360,c=+i[1]/100,u=+i[2]/100,a=u<=.5?u*(c+1):u+c-u*c,s=u*2-a,i.length>3&&(i[3]*=1),i[0]=Jl(l+1/3,s,a),i[1]=Jl(l,s,a),i[2]=Jl(l-1/3,s,a);else if(~e.indexOf("="))return i=e.match(zd),n&&i.length<4&&(i[3]=1),i}else i=e.match(Cc)||io.transparent;i=i.map(Number)}return t&&!g&&(s=i[0]/pt,a=i[1]/pt,o=i[2]/pt,h=Math.max(s,a,o),f=Math.min(s,a,o),u=(h+f)/2,h===f?l=c=0:(d=h-f,c=u>.5?d/(2-h-f):d/(h+f),l=h===s?(a-o)/d+(a<o?6:0):h===a?(o-s)/d+2:(s-a)/d+4,l*=60),i[0]=~~(l+.5),i[1]=~~(c*100+.5),i[2]=~~(u*100+.5)),n&&i.length<4&&(i[3]=1),i},cp=function(e){var t=[],n=[],i=-1;return e.split(sr).forEach(function(s){var a=s.match(vs)||[];t.push.apply(t,a),n.push(i+=a.length+1)}),t.c=n,t},vf=function(e,t,n){var i="",s=(e+i).match(sr),a=t?"hsla(":"rgba(",o=0,l,c,u,h;if(!s)return e;if(s=s.map(function(f){return(f=lp(f,t,1))&&a+(t?f[0]+","+f[1]+"%,"+f[2]+"%,"+f[3]:f.join(","))+")"}),n&&(u=cp(e),l=n.c,l.join(i)!==u.c.join(i)))for(c=e.replace(sr,"1").split(vs),h=c.length-1;o<h;o++)i+=c[o]+(~l.indexOf(o)?s.shift()||a+"0,0,0,0)":(u.length?u:s.length?s:n).shift());if(!c)for(c=e.split(sr),h=c.length-1;o<h;o++)i+=c[o]+s[o];return i+c[h]},sr=function(){var r="(?:\\b(?:(?:rgb|rgba|hsl|hsla)\\(.+?\\))|\\B#(?:[0-9a-f]{3,4}){1,2}\\b",e;for(e in io)r+="|"+e+"\\b";return new RegExp(r+")","gi")}(),KS=/hsl[a]?\(/,up=function(e){var t=e.join(" "),n;if(sr.lastIndex=0,sr.test(t))return n=KS.test(t),e[1]=vf(e[1],n),e[0]=vf(e[0],n,cp(e[1])),!0},Ro,kn=function(){var r=Date.now,e=500,t=33,n=r(),i=n,s=1e3/240,a=s,o=[],l,c,u,h,f,d,g=function _(m){var p=r()-i,M=m===!0,v,S,E,A;if((p>e||p<0)&&(n+=p-t),i+=p,E=i-n,v=E-a,(v>0||M)&&(A=++h.frame,f=E-h.time*1e3,h.time=E=E/1e3,a+=v+(v>=s?4:s-v),S=1),M||(l=c(_)),S)for(d=0;d<o.length;d++)o[d](E,f,A,m)};return h={time:0,frame:0,tick:function(){g(!0)},deltaRatio:function(m){return f/(1e3/(m||60))},wake:function(){Hd&&(!Pc&&su()&&(pi=Pc=window,ou=pi.document||{},Wn.gsap=Cn,(pi.gsapVersions||(pi.gsapVersions=[])).push(Cn.version),Gd(Xa||pi.GreenSockGlobals||!pi.gsap&&pi||{}),op.forEach(ap)),u=typeof requestAnimationFrame<"u"&&requestAnimationFrame,l&&h.sleep(),c=u||function(m){return setTimeout(m,a-h.time*1e3+1|0)},Ro=1,g(2))},sleep:function(){(u?cancelAnimationFrame:clearTimeout)(l),Ro=0,c=wo},lagSmoothing:function(m,p){e=m||1/0,t=Math.min(p||33,e)},fps:function(m){s=1e3/(m||240),a=h.time*1e3+s},add:function(m,p,M){var v=p?function(S,E,A,w){m(S,E,A,w),h.remove(v)}:m;return h.remove(m),o[M?"unshift":"push"](v),Os(),v},remove:function(m,p){~(p=o.indexOf(m))&&o.splice(p,1)&&d>=p&&d--},_listeners:o},h}(),Os=function(){return!Ro&&kn.wake()},ot={},ZS=/^[\d.\-M][\d.\-,\s]/,jS=/["']/g,JS=function(e){for(var t={},n=e.substr(1,e.length-3).split(":"),i=n[0],s=1,a=n.length,o,l,c;s<a;s++)l=n[s],o=s!==a-1?l.lastIndexOf(","):l.length,c=l.substr(0,o),t[i]=isNaN(c)?c.replace(jS,"").trim():+c,i=l.substr(o+1).trim();return t},QS=function(e){var t=e.indexOf("(")+1,n=e.indexOf(")"),i=e.indexOf("(",t);return e.substring(t,~i&&i<n?e.indexOf(")",n+1):n)},eM=function(e){var t=(e+"").split("("),n=ot[t[0]];return n&&t.length>1&&n.config?n.config.apply(null,~e.indexOf("{")?[JS(t[1])]:QS(e).split(",").map(Yd)):ot._CE&&ZS.test(e)?ot._CE("",e):n},hp=function(e){return function(t){return 1-e(1-t)}},fp=function r(e,t){for(var n=e._first,i;n;)n instanceof vn?r(n,t):n.vars.yoyoEase&&(!n._yoyo||!n._repeat)&&n._yoyo!==t&&(n.timeline?r(n.timeline,t):(i=n._ease,n._ease=n._yEase,n._yEase=i,n._yoyo=t)),n=n._next},zr=function(e,t){return e&&(Ct(e)?e:ot[e]||eM(e))||t},$r=function(e,t,n,i){n===void 0&&(n=function(l){return 1-t(1-l)}),i===void 0&&(i=function(l){return l<.5?t(l*2)/2:1-t((1-l)*2)/2});var s={easeIn:t,easeOut:n,easeInOut:i},a;return wn(e,function(o){ot[o]=Wn[o]=s,ot[a=o.toLowerCase()]=n;for(var l in s)ot[a+(l==="easeIn"?".in":l==="easeOut"?".out":".inOut")]=ot[o+"."+l]=s[l]}),s},dp=function(e){return function(t){return t<.5?(1-e(1-t*2))/2:.5+e((t-.5)*2)/2}},Ql=function r(e,t,n){var i=t>=1?t:1,s=(n||(e?.3:.45))/(t<1?t:1),a=s/Rc*(Math.asin(1/i)||0),o=function(u){return u===1?1:i*Math.pow(2,-10*u)*RS((u-a)*s)+1},l=e==="out"?o:e==="in"?function(c){return 1-o(1-c)}:dp(o);return s=Rc/s,l.config=function(c,u){return r(e,c,u)},l},ec=function r(e,t){t===void 0&&(t=1.70158);var n=function(a){return a?--a*a*((t+1)*a+t)+1:0},i=e==="out"?n:e==="in"?function(s){return 1-n(1-s)}:dp(n);return i.config=function(s){return r(e,s)},i};wn("Linear,Quad,Cubic,Quart,Quint,Strong",function(r,e){var t=e<5?e+1:e;$r(r+",Power"+(t-1),e?function(n){return Math.pow(n,t)}:function(n){return n},function(n){return 1-Math.pow(1-n,t)},function(n){return n<.5?Math.pow(n*2,t)/2:1-Math.pow((1-n)*2,t)/2})});ot.Linear.easeNone=ot.none=ot.Linear.easeIn;$r("Elastic",Ql("in"),Ql("out"),Ql());(function(r,e){var t=1/e,n=2*t,i=2.5*t,s=function(o){return o<t?r*o*o:o<n?r*Math.pow(o-1.5/e,2)+.75:o<i?r*(o-=2.25/e)*o+.9375:r*Math.pow(o-2.625/e,2)+.984375};$r("Bounce",function(a){return 1-s(1-a)},s)})(7.5625,2.75);$r("Expo",function(r){return r?Math.pow(2,10*(r-1)):0});$r("Circ",function(r){return-(Od(1-r*r)-1)});$r("Sine",function(r){return r===1?1:-AS(r*bS)+1});$r("Back",ec("in"),ec("out"),ec());ot.SteppedEase=ot.steps=Wn.SteppedEase={config:function(e,t){e===void 0&&(e=1);var n=1/e,i=e+(t?0:1),s=t?1:0,a=1-vt;return function(o){return((i*Bo(0,a,o)|0)+s)*n}}};Us.ease=ot["quad.out"];wn("onComplete,onUpdate,onStart,onRepeat,onReverseComplete,onInterrupt",function(r){return cu+=r+","+r+"Params,"});var pp=function(e,t){this.id=wS++,e._gsap=this,this.target=e,this.harness=t,this.get=t?t.get:Xd,this.set=t?t.getSetter:pu},Co=function(){function r(t){this.vars=t,this._delay=+t.delay||0,(this._repeat=t.repeat===1/0?-2:t.repeat||0)&&(this._rDelay=t.repeatDelay||0,this._yoyo=!!t.yoyo||!!t.yoyoEase),this._ts=1,Ns(this,+t.duration,1,1),this.data=t.data,Tt&&(this._ctx=Tt,Tt.data.push(this)),Ro||kn.wake()}var e=r.prototype;return e.delay=function(n){return n||n===0?(this.parent&&this.parent.smoothChildTiming&&this.startTime(this._start+n-this._delay),this._delay=n,this):this._delay},e.duration=function(n){return arguments.length?this.totalDuration(this._repeat>0?n+(n+this._rDelay)*this._repeat:n):this.totalDuration()&&this._dur},e.totalDuration=function(n){return arguments.length?(this._dirty=0,Ns(this,this._repeat<0?n:(n-this._repeat*this._rDelay)/(this._repeat+1))):this._tDur},e.totalTime=function(n,i){if(Os(),!arguments.length)return this._tTime;var s=this._dp;if(s&&s.smoothChildTiming&&this._ts){for(al(this,n),!s._dp||s.parent||Zd(s,this);s&&s.parent;)s.parent._time!==s._start+(s._ts>=0?s._tTime/s._ts:(s.totalDuration()-s._tTime)/-s._ts)&&s.totalTime(s._tTime,!0),s=s.parent;!this.parent&&this._dp.autoRemoveChildren&&(this._ts>0&&n<this._tDur||this._ts<0&&n>0||!this._tDur&&!n)&&_i(this._dp,this,this._start-this._delay)}return(this._tTime!==n||!this._dur&&!i||this._initted&&Math.abs(this._zTime)===vt||!n&&!this._initted&&(this.add||this._ptLookup))&&(this._ts||(this._pTime=n),qd(this,n,i)),this},e.time=function(n,i){return arguments.length?this.totalTime(Math.min(this.totalDuration(),n+mf(this))%(this._dur+this._rDelay)||(n?this._dur:0),i):this._time},e.totalProgress=function(n,i){return arguments.length?this.totalTime(this.totalDuration()*n,i):this.totalDuration()?Math.min(1,this._tTime/this._tDur):this.rawTime()>0?1:0},e.progress=function(n,i){return arguments.length?this.totalTime(this.duration()*(this._yoyo&&!(this.iteration()&1)?1-n:n)+mf(this),i):this.duration()?Math.min(1,this._time/this._dur):this.rawTime()>0?1:0},e.iteration=function(n,i){var s=this.duration()+this._rDelay;return arguments.length?this.totalTime(this._time+(n-1)*s,i):this._repeat?Is(this._tTime,s)+1:1},e.timeScale=function(n,i){if(!arguments.length)return this._rts===-vt?0:this._rts;if(this._rts===n)return this;var s=this.parent&&this._ts?$a(this.parent._time,this):this._tTime;return this._rts=+n||0,this._ts=this._ps||n===-vt?0:this._rts,this.totalTime(Bo(-Math.abs(this._delay),this._tDur,s),i!==!1),ol(this),NS(this)},e.paused=function(n){return arguments.length?(this._ps!==n&&(this._ps=n,n?(this._pTime=this._tTime||Math.max(-this._delay,this.rawTime()),this._ts=this._act=0):(Os(),this._ts=this._rts,this.totalTime(this.parent&&!this.parent.smoothChildTiming?this.rawTime():this._tTime||this._pTime,this.progress()===1&&Math.abs(this._zTime)!==vt&&(this._tTime-=vt)))),this):this._ps},e.startTime=function(n){if(arguments.length){this._start=n;var i=this.parent||this._dp;return i&&(i._sort||!this.parent)&&_i(i,this,n-this._delay),this}return this._start},e.endTime=function(n){return this._start+(bn(n)?this.totalDuration():this.duration())/Math.abs(this._ts||1)},e.rawTime=function(n){var i=this.parent||this._dp;return i?n&&(!this._ts||this._repeat&&this._time&&this.totalProgress()<1)?this._tTime%(this._dur+this._rDelay):this._ts?$a(i.rawTime(n),this):this._tTime:this._tTime},e.revert=function(n){n===void 0&&(n=LS);var i=rn;return rn=n,(this._initted||this._startAt)&&(this.timeline&&this.timeline.revert(n),this.totalTime(-.01,n.suppressEvents)),this.data!=="nested"&&n.kill!==!1&&this.kill(),rn=i,this},e.globalTime=function(n){for(var i=this,s=arguments.length?n:i.rawTime();i;)s=i._start+s/(Math.abs(i._ts)||1),i=i._dp;return!this.parent&&this._sat?this._sat.globalTime(n):s},e.repeat=function(n){return arguments.length?(this._repeat=n===1/0?-2:n,_f(this)):this._repeat===-2?1/0:this._repeat},e.repeatDelay=function(n){if(arguments.length){var i=this._time;return this._rDelay=n,_f(this),i?this.time(i):this}return this._rDelay},e.yoyo=function(n){return arguments.length?(this._yoyo=n,this):this._yoyo},e.seek=function(n,i){return this.totalTime(qn(this,n),bn(i))},e.restart=function(n,i){return this.play().totalTime(n?-this._delay:0,bn(i))},e.play=function(n,i){return n!=null&&this.seek(n,i),this.reversed(!1).paused(!1)},e.reverse=function(n,i){return n!=null&&this.seek(n||this.totalDuration(),i),this.reversed(!0).paused(!1)},e.pause=function(n,i){return n!=null&&this.seek(n,i),this.paused(!0)},e.resume=function(){return this.paused(!1)},e.reversed=function(n){return arguments.length?(!!n!==this.reversed()&&this.timeScale(-this._rts||(n?-vt:0)),this):this._rts<0},e.invalidate=function(){return this._initted=this._act=0,this._zTime=-vt,this},e.isActive=function(){var n=this.parent||this._dp,i=this._start,s;return!!(!n||this._ts&&this._initted&&n.isActive()&&(s=n.rawTime(!0))>=i&&s<this.endTime(!0)-vt)},e.eventCallback=function(n,i,s){var a=this.vars;return arguments.length>1?(i?(a[n]=i,s&&(a[n+"Params"]=s),n==="onUpdate"&&(this._onUpdate=i)):delete a[n],this):a[n]},e.then=function(n){var i=this;return new Promise(function(s){var a=Ct(n)?n:$d,o=function(){var c=i.then;i.then=null,Ct(a)&&(a=a(i))&&(a.then||a===i)&&(i.then=c),s(a),i.then=c};i._initted&&i.totalProgress()===1&&i._ts>=0||!i._tTime&&i._ts<0?o():i._prom=o})},e.kill=function(){no(this)},r}();ei(Co.prototype,{_time:0,_start:0,_end:0,_tTime:0,_tDur:0,_dirty:0,_repeat:0,_yoyo:!1,parent:null,_initted:!1,_rDelay:0,_ts:1,_dp:0,ratio:0,_zTime:-vt,_prom:0,_ps:!1,_rts:1});var vn=function(r){Nd(e,r);function e(n,i){var s;return n===void 0&&(n={}),s=r.call(this,n)||this,s.labels={},s.smoothChildTiming=!!n.smoothChildTiming,s.autoRemoveChildren=!!n.autoRemoveChildren,s._sort=bn(n.sortChildren),At&&_i(n.parent||At,Ci(s),i),n.reversed&&s.reverse(),n.paused&&s.paused(!0),n.scrollTrigger&&jd(Ci(s),n.scrollTrigger),s}var t=e.prototype;return t.to=function(i,s,a){return go(0,arguments,this),this},t.from=function(i,s,a){return go(1,arguments,this),this},t.fromTo=function(i,s,a,o){return go(2,arguments,this),this},t.set=function(i,s,a){return s.duration=0,s.parent=this,_o(s).repeatDelay||(s.repeat=0),s.immediateRender=!!s.immediateRender,new Nt(i,s,qn(this,a),1),this},t.call=function(i,s,a){return _i(this,Nt.delayedCall(0,i,s),a)},t.staggerTo=function(i,s,a,o,l,c,u){return a.duration=s,a.stagger=a.stagger||o,a.onComplete=c,a.onCompleteParams=u,a.parent=this,new Nt(i,a,qn(this,l)),this},t.staggerFrom=function(i,s,a,o,l,c,u){return a.runBackwards=1,_o(a).immediateRender=bn(a.immediateRender),this.staggerTo(i,s,a,o,l,c,u)},t.staggerFromTo=function(i,s,a,o,l,c,u,h){return o.startAt=a,_o(o).immediateRender=bn(o.immediateRender),this.staggerTo(i,s,o,l,c,u,h)},t.render=function(i,s,a){var o=this._time,l=this._dirty?this.totalDuration():this._tDur,c=this._dur,u=i<=0?0:qt(i),h=this._zTime<0!=i<0&&(this._initted||!c),f,d,g,_,m,p,M,v,S,E,A,w;if(this!==At&&u>l&&i>=0&&(u=l),u!==this._tTime||a||h){if(o!==this._time&&c&&(u+=this._time-o,i+=this._time-o),f=u,S=this._start,v=this._ts,p=!v,h&&(c||(o=this._zTime),(i||!s)&&(this._zTime=i)),this._repeat){if(A=this._yoyo,m=c+this._rDelay,this._repeat<-1&&i<0)return this.totalTime(m*100+i,s,a);if(f=qt(u%m),u===l?(_=this._repeat,f=c):(_=~~(u/m),_&&_===u/m&&(f=c,_--),f>c&&(f=c)),E=Is(this._tTime,m),!o&&this._tTime&&E!==_&&this._tTime-E*m-this._dur<=0&&(E=_),A&&_&1&&(f=c-f,w=1),_!==E&&!this._lock){var D=A&&E&1,x=D===(A&&_&1);if(_<E&&(D=!D),o=D?0:u%c?c:u,this._lock=1,this.render(o||(w?0:qt(_*m)),s,!c)._lock=0,this._tTime=u,!s&&this.parent&&Hn(this,"onRepeat"),this.vars.repeatRefresh&&!w&&(this.invalidate()._lock=1),o&&o!==this._time||p!==!this._ts||this.vars.onRepeat&&!this.parent&&!this._act)return this;if(c=this._dur,l=this._tDur,x&&(this._lock=2,o=D?c:-1e-4,this.render(o,!0),this.vars.repeatRefresh&&!w&&this.invalidate()),this._lock=0,!this._ts&&!p)return this;fp(this,w)}}if(this._hasPause&&!this._forcing&&this._lock<2&&(M=BS(this,qt(o),qt(f)),M&&(u-=f-(f=M._start))),this._tTime=u,this._time=f,this._act=!v,this._initted||(this._onUpdate=this.vars.onUpdate,this._initted=1,this._zTime=i,o=0),!o&&f&&!s&&!_&&(Hn(this,"onStart"),this._tTime!==u))return this;if(f>=o&&i>=0)for(d=this._first;d;){if(g=d._next,(d._act||f>=d._start)&&d._ts&&M!==d){if(d.parent!==this)return this.render(i,s,a);if(d.render(d._ts>0?(f-d._start)*d._ts:(d._dirty?d.totalDuration():d._tDur)+(f-d._start)*d._ts,s,a),f!==this._time||!this._ts&&!p){M=0,g&&(u+=this._zTime=-vt);break}}d=g}else{d=this._last;for(var b=i<0?i:f;d;){if(g=d._prev,(d._act||b<=d._end)&&d._ts&&M!==d){if(d.parent!==this)return this.render(i,s,a);if(d.render(d._ts>0?(b-d._start)*d._ts:(d._dirty?d.totalDuration():d._tDur)+(b-d._start)*d._ts,s,a||rn&&(d._initted||d._startAt)),f!==this._time||!this._ts&&!p){M=0,g&&(u+=this._zTime=b?-vt:vt);break}}d=g}}if(M&&!s&&(this.pause(),M.render(f>=o?0:-vt)._zTime=f>=o?1:-1,this._ts))return this._start=S,ol(this),this.render(i,s,a);this._onUpdate&&!s&&Hn(this,"onUpdate",!0),(u===l&&this._tTime>=this.totalDuration()||!u&&o)&&(S===this._start||Math.abs(v)!==Math.abs(this._ts))&&(this._lock||((i||!c)&&(u===l&&this._ts>0||!u&&this._ts<0)&&lr(this,1),!s&&!(i<0&&!o)&&(u||o||!l)&&(Hn(this,u===l&&i>=0?"onComplete":"onReverseComplete",!0),this._prom&&!(u<l&&this.timeScale()>0)&&this._prom())))}return this},t.add=function(i,s){var a=this;if(zi(s)||(s=qn(this,s,i)),!(i instanceof Co)){if(sn(i))return i.forEach(function(o){return a.add(o,s)}),this;if($t(i))return this.addLabel(i,s);if(Ct(i))i=Nt.delayedCall(0,i);else return this}return this!==i?_i(this,i,s):this},t.getChildren=function(i,s,a,o){i===void 0&&(i=!0),s===void 0&&(s=!0),a===void 0&&(a=!0),o===void 0&&(o=-jn);for(var l=[],c=this._first;c;)c._start>=o&&(c instanceof Nt?s&&l.push(c):(a&&l.push(c),i&&l.push.apply(l,c.getChildren(!0,s,a)))),c=c._next;return l},t.getById=function(i){for(var s=this.getChildren(1,1,1),a=s.length;a--;)if(s[a].vars.id===i)return s[a]},t.remove=function(i){return $t(i)?this.removeLabel(i):Ct(i)?this.killTweensOf(i):(sl(this,i),i===this._recent&&(this._recent=this._last),Fr(this))},t.totalTime=function(i,s){return arguments.length?(this._forcing=1,!this._dp&&this._ts&&(this._start=qt(kn.time-(this._ts>0?i/this._ts:(this.totalDuration()-i)/-this._ts))),r.prototype.totalTime.call(this,i,s),this._forcing=0,this):this._tTime},t.addLabel=function(i,s){return this.labels[i]=qn(this,s),this},t.removeLabel=function(i){return delete this.labels[i],this},t.addPause=function(i,s,a){var o=Nt.delayedCall(0,s||wo,a);return o.data="isPause",this._hasPause=1,_i(this,o,qn(this,i))},t.removePause=function(i){var s=this._first;for(i=qn(this,i);s;)s._start===i&&s.data==="isPause"&&lr(s),s=s._next},t.killTweensOf=function(i,s,a){for(var o=this.getTweensOf(i,a),l=o.length;l--;)ji!==o[l]&&o[l].kill(i,s);return this},t.getTweensOf=function(i,s){for(var a=[],o=Jn(i),l=this._first,c=zi(s),u;l;)l instanceof Nt?DS(l._targets,o)&&(c?(!ji||l._initted&&l._ts)&&l.globalTime(0)<=s&&l.globalTime(l.totalDuration())>s:!s||l.isActive())&&a.push(l):(u=l.getTweensOf(o,s)).length&&a.push.apply(a,u),l=l._next;return a},t.tweenTo=function(i,s){s=s||{};var a=this,o=qn(a,i),l=s,c=l.startAt,u=l.onStart,h=l.onStartParams,f=l.immediateRender,d,g=Nt.to(a,ei({ease:s.ease||"none",lazy:!1,immediateRender:!1,time:o,overwrite:"auto",duration:s.duration||Math.abs((o-(c&&"time"in c?c.time:a._time))/a.timeScale())||vt,onStart:function(){if(a.pause(),!d){var m=s.duration||Math.abs((o-(c&&"time"in c?c.time:a._time))/a.timeScale());g._dur!==m&&Ns(g,m,0,1).render(g._time,!0,!0),d=1}u&&u.apply(g,h||[])}},s));return f?g.render(0):g},t.tweenFromTo=function(i,s,a){return this.tweenTo(s,ei({startAt:{time:qn(this,i)}},a))},t.recent=function(){return this._recent},t.nextLabel=function(i){return i===void 0&&(i=this._time),gf(this,qn(this,i))},t.previousLabel=function(i){return i===void 0&&(i=this._time),gf(this,qn(this,i),1)},t.currentLabel=function(i){return arguments.length?this.seek(i,!0):this.previousLabel(this._time+vt)},t.shiftChildren=function(i,s,a){a===void 0&&(a=0);for(var o=this._first,l=this.labels,c;o;)o._start>=a&&(o._start+=i,o._end+=i),o=o._next;if(s)for(c in l)l[c]>=a&&(l[c]+=i);return Fr(this)},t.invalidate=function(i){var s=this._first;for(this._lock=0;s;)s.invalidate(i),s=s._next;return r.prototype.invalidate.call(this,i)},t.clear=function(i){i===void 0&&(i=!0);for(var s=this._first,a;s;)a=s._next,this.remove(s),s=a;return this._dp&&(this._time=this._tTime=this._pTime=0),i&&(this.labels={}),Fr(this)},t.totalDuration=function(i){var s=0,a=this,o=a._last,l=jn,c,u,h;if(arguments.length)return a.timeScale((a._repeat<0?a.duration():a.totalDuration())/(a.reversed()?-i:i));if(a._dirty){for(h=a.parent;o;)c=o._prev,o._dirty&&o.totalDuration(),u=o._start,u>l&&a._sort&&o._ts&&!a._lock?(a._lock=1,_i(a,o,u-o._delay,1)._lock=0):l=u,u<0&&o._ts&&(s-=u,(!h&&!a._dp||h&&h.smoothChildTiming)&&(a._start+=u/a._ts,a._time-=u,a._tTime-=u),a.shiftChildren(-u,!1,-1/0),l=0),o._end>s&&o._ts&&(s=o._end),o=c;Ns(a,a===At&&a._time>s?a._time:s,1,1),a._dirty=0}return a._tDur},e.updateRoot=function(i){if(At._ts&&(qd(At,$a(i,At)),Wd=kn.frame),kn.frame>=df){df+=Vn.autoSleep||120;var s=At._first;if((!s||!s._ts)&&Vn.autoSleep&&kn._listeners.length<2){for(;s&&!s._ts;)s=s._next;s||kn.sleep()}}},e}(Co);ei(vn.prototype,{_lock:0,_hasPause:0,_forcing:0});var tM=function(e,t,n,i,s,a,o){var l=new An(this._pt,e,t,0,1,Sp,null,s),c=0,u=0,h,f,d,g,_,m,p,M;for(l.b=n,l.e=i,n+="",i+="",(p=~i.indexOf("random("))&&(i=Ao(i)),a&&(M=[n,i],a(M,e,t),n=M[0],i=M[1]),f=n.match(Zl)||[];h=Zl.exec(i);)g=h[0],_=i.substring(c,h.index),d?d=(d+1)%5:_.substr(-5)==="rgba("&&(d=1),g!==f[u++]&&(m=parseFloat(f[u-1])||0,l._pt={_next:l._pt,p:_||u===1?_:",",s:m,c:g.charAt(1)==="="?bs(m,g)-m:parseFloat(g)-m,m:d&&d<4?Math.round:0},c=Zl.lastIndex);return l.c=c<i.length?i.substring(c,i.length):"",l.fp=o,(Bd.test(i)||p)&&(l.e=0),this._pt=l,l},hu=function(e,t,n,i,s,a,o,l,c,u){Ct(i)&&(i=i(s||0,e,a));var h=e[t],f=n!=="get"?n:Ct(h)?c?e[t.indexOf("set")||!Ct(e["get"+t.substr(3)])?t:"get"+t.substr(3)](c):e[t]():h,d=Ct(h)?c?oM:vp:du,g;if($t(i)&&(~i.indexOf("random(")&&(i=Ao(i)),i.charAt(1)==="="&&(g=bs(f,i)+(nn(f)||0),(g||g===0)&&(i=g))),!u||f!==i||Fc)return!isNaN(f*i)&&i!==""?(g=new An(this._pt,e,t,+f||0,i-(f||0),typeof h=="boolean"?lM:xp,0,d),c&&(g.fp=c),o&&g.modifier(o,this,e),this._pt=g):(!h&&!(t in e)&&au(t,i),tM.call(this,e,t,f,i,d,l||Vn.stringFilter,c))},nM=function(e,t,n,i,s){if(Ct(e)&&(e=vo(e,s,t,n,i)),!Mi(e)||e.style&&e.nodeType||sn(e)||Fd(e))return $t(e)?vo(e,s,t,n,i):e;var a={},o;for(o in e)a[o]=vo(e[o],s,t,n,i);return a},mp=function(e,t,n,i,s,a){var o,l,c,u;if(Fn[e]&&(o=new Fn[e]).init(s,o.rawVars?t[e]:nM(t[e],i,s,a,n),n,i,a)!==!1&&(n._pt=l=new An(n._pt,s,e,0,1,o.render,o,0,o.priority),n!==xs))for(c=n._ptLookup[n._targets.indexOf(s)],u=o._props.length;u--;)c[o._props[u]]=l;return o},ji,Fc,fu=function r(e,t,n){var i=e.vars,s=i.ease,a=i.startAt,o=i.immediateRender,l=i.lazy,c=i.onUpdate,u=i.runBackwards,h=i.yoyoEase,f=i.keyframes,d=i.autoRevert,g=e._dur,_=e._startAt,m=e._targets,p=e.parent,M=p&&p.data==="nested"?p.vars.targets:m,v=e._overwrite==="auto"&&!iu,S=e.timeline,E,A,w,D,x,b,F,N,Z,P,z,q,O;if(S&&(!f||!s)&&(s="none"),e._ease=zr(s,Us.ease),e._yEase=h?hp(zr(h===!0?s:h,Us.ease)):0,h&&e._yoyo&&!e._repeat&&(h=e._yEase,e._yEase=e._ease,e._ease=h),e._from=!S&&!!i.runBackwards,!S||f&&!i.stagger){if(N=m[0]?Or(m[0]).harness:0,q=N&&i[N.prop],E=Ya(i,lu),_&&(_._zTime<0&&_.progress(1),t<0&&u&&o&&!d?_.render(-1,!0):_.revert(u&&g?Pa:PS),_._lazy=0),a){if(lr(e._startAt=Nt.set(m,ei({data:"isStart",overwrite:!1,parent:p,immediateRender:!0,lazy:!_&&bn(l),startAt:null,delay:0,onUpdate:c&&function(){return Hn(e,"onUpdate")},stagger:0},a))),e._startAt._dp=0,e._startAt._sat=e,t<0&&(rn||!o&&!d)&&e._startAt.revert(Pa),o&&g&&t<=0&&n<=0){t&&(e._zTime=t);return}}else if(u&&g&&!_){if(t&&(o=!1),w=ei({overwrite:!1,data:"isFromStart",lazy:o&&!_&&bn(l),immediateRender:o,stagger:0,parent:p},E),q&&(w[N.prop]=q),lr(e._startAt=Nt.set(m,w)),e._startAt._dp=0,e._startAt._sat=e,t<0&&(rn?e._startAt.revert(Pa):e._startAt.render(-1,!0)),e._zTime=t,!o)r(e._startAt,vt,vt);else if(!t)return}for(e._pt=e._ptCache=0,l=g&&bn(l)||l&&!g,A=0;A<m.length;A++){if(x=m[A],F=x._gsap||uu(m)[A]._gsap,e._ptLookup[A]=P={},Lc[F.id]&&rr.length&&qa(),z=M===m?A:M.indexOf(x),N&&(Z=new N).init(x,q||E,e,z,M)!==!1&&(e._pt=D=new An(e._pt,x,Z.name,0,1,Z.render,Z,0,Z.priority),Z._props.forEach(function(j){P[j]=D}),Z.priority&&(b=1)),!N||q)for(w in E)Fn[w]&&(Z=mp(w,E,e,z,x,M))?Z.priority&&(b=1):P[w]=D=hu.call(e,x,w,"get",E[w],z,M,0,i.stringFilter);e._op&&e._op[A]&&e.kill(x,e._op[A]),v&&e._pt&&(ji=e,At.killTweensOf(x,P,e.globalTime(t)),O=!e.parent,ji=0),e._pt&&l&&(Lc[F.id]=1)}b&&Mp(e),e._onInit&&e._onInit(e)}e._onUpdate=c,e._initted=(!e._op||e._pt)&&!O,f&&t<=0&&S.render(jn,!0,!0)},iM=function(e,t,n,i,s,a,o,l){var c=(e._pt&&e._ptCache||(e._ptCache={}))[t],u,h,f,d;if(!c)for(c=e._ptCache[t]=[],f=e._ptLookup,d=e._targets.length;d--;){if(u=f[d][t],u&&u.d&&u.d._pt)for(u=u.d._pt;u&&u.p!==t&&u.fp!==t;)u=u._next;if(!u)return Fc=1,e.vars[t]="+=0",fu(e,o),Fc=0,l?bo(t+" not eligible for reset"):1;c.push(u)}for(d=c.length;d--;)h=c[d],u=h._pt||h,u.s=(i||i===0)&&!s?i:u.s+(i||0)+a*u.c,u.c=n-u.s,h.e&&(h.e=Pt(n)+nn(h.e)),h.b&&(h.b=u.s+nn(h.b))},rM=function(e,t){var n=e[0]?Or(e[0]).harness:0,i=n&&n.aliases,s,a,o,l;if(!i)return t;s=qr({},t);for(a in i)if(a in s)for(l=i[a].split(","),o=l.length;o--;)s[l[o]]=s[a];return s},sM=function(e,t,n,i){var s=t.ease||i||"power1.inOut",a,o;if(sn(t))o=n[e]||(n[e]=[]),t.forEach(function(l,c){return o.push({t:c/(t.length-1)*100,v:l,e:s})});else for(a in t)o=n[a]||(n[a]=[]),a==="ease"||o.push({t:parseFloat(e),v:t[a],e:s})},vo=function(e,t,n,i,s){return Ct(e)?e.call(t,n,i,s):$t(e)&&~e.indexOf("random(")?Ao(e):e},_p=cu+"repeat,repeatDelay,yoyo,repeatRefresh,yoyoEase,autoRevert",gp={};wn(_p+",id,stagger,delay,duration,paused,scrollTrigger",function(r){return gp[r]=1});var Nt=function(r){Nd(e,r);function e(n,i,s,a){var o;typeof i=="number"&&(s.duration=i,i=s,s=null),o=r.call(this,a?i:_o(i))||this;var l=o.vars,c=l.duration,u=l.delay,h=l.immediateRender,f=l.stagger,d=l.overwrite,g=l.keyframes,_=l.defaults,m=l.scrollTrigger,p=l.yoyoEase,M=i.parent||At,v=(sn(n)||Fd(n)?zi(n[0]):"length"in i)?[n]:Jn(n),S,E,A,w,D,x,b,F;if(o._targets=v.length?uu(v):bo("GSAP target "+n+" not found. https://gsap.com",!Vn.nullTargetWarn)||[],o._ptLookup=[],o._overwrite=d,g||f||ya(c)||ya(u)){if(i=o.vars,S=o.timeline=new vn({data:"nested",defaults:_||{},targets:M&&M.data==="nested"?M.vars.targets:v}),S.kill(),S.parent=S._dp=Ci(o),S._start=0,f||ya(c)||ya(u)){if(w=v.length,b=f&&tp(f),Mi(f))for(D in f)~_p.indexOf(D)&&(F||(F={}),F[D]=f[D]);for(E=0;E<w;E++)A=Ya(i,gp),A.stagger=0,p&&(A.yoyoEase=p),F&&qr(A,F),x=v[E],A.duration=+vo(c,Ci(o),E,x,v),A.delay=(+vo(u,Ci(o),E,x,v)||0)-o._delay,!f&&w===1&&A.delay&&(o._delay=u=A.delay,o._start+=u,A.delay=0),S.to(x,A,b?b(E,x,v):0),S._ease=ot.none;S.duration()?c=u=0:o.timeline=0}else if(g){_o(ei(S.vars.defaults,{ease:"none"})),S._ease=zr(g.ease||i.ease||"none");var N=0,Z,P,z;if(sn(g))g.forEach(function(q){return S.to(v,q,">")}),S.duration();else{A={};for(D in g)D==="ease"||D==="easeEach"||sM(D,g[D],A,g.easeEach);for(D in A)for(Z=A[D].sort(function(q,O){return q.t-O.t}),N=0,E=0;E<Z.length;E++)P=Z[E],z={ease:P.e,duration:(P.t-(E?Z[E-1].t:0))/100*c},z[D]=P.v,S.to(v,z,N),N+=z.duration;S.duration()<c&&S.to({},{duration:c-S.duration()})}}c||o.duration(c=S.duration())}else o.timeline=0;return d===!0&&!iu&&(ji=Ci(o),At.killTweensOf(v),ji=0),_i(M,Ci(o),s),i.reversed&&o.reverse(),i.paused&&o.paused(!0),(h||!c&&!g&&o._start===qt(M._time)&&bn(h)&&OS(Ci(o))&&M.data!=="nested")&&(o._tTime=-vt,o.render(Math.max(0,-u)||0)),m&&jd(Ci(o),m),o}var t=e.prototype;return t.render=function(i,s,a){var o=this._time,l=this._tDur,c=this._dur,u=i<0,h=i>l-vt&&!u?l:i<vt?0:i,f,d,g,_,m,p,M,v,S;if(!c)zS(this,i,s,a);else if(h!==this._tTime||!i||a||!this._initted&&this._tTime||this._startAt&&this._zTime<0!==u){if(f=h,v=this.timeline,this._repeat){if(_=c+this._rDelay,this._repeat<-1&&u)return this.totalTime(_*100+i,s,a);if(f=qt(h%_),h===l?(g=this._repeat,f=c):(g=~~(h/_),g&&g===qt(h/_)&&(f=c,g--),f>c&&(f=c)),p=this._yoyo&&g&1,p&&(S=this._yEase,f=c-f),m=Is(this._tTime,_),f===o&&!a&&this._initted&&g===m)return this._tTime=h,this;g!==m&&(v&&this._yEase&&fp(v,p),this.vars.repeatRefresh&&!p&&!this._lock&&this._time!==_&&this._initted&&(this._lock=a=1,this.render(qt(_*g),!0).invalidate()._lock=0))}if(!this._initted){if(Jd(this,u?i:f,a,s,h))return this._tTime=0,this;if(o!==this._time&&!(a&&this.vars.repeatRefresh&&g!==m))return this;if(c!==this._dur)return this.render(i,s,a)}if(this._tTime=h,this._time=f,!this._act&&this._ts&&(this._act=1,this._lazy=0),this.ratio=M=(S||this._ease)(f/c),this._from&&(this.ratio=M=1-M),f&&!o&&!s&&!g&&(Hn(this,"onStart"),this._tTime!==h))return this;for(d=this._pt;d;)d.r(M,d.d),d=d._next;v&&v.render(i<0?i:v._dur*v._ease(f/this._dur),s,a)||this._startAt&&(this._zTime=i),this._onUpdate&&!s&&(u&&Dc(this,i,s,a),Hn(this,"onUpdate")),this._repeat&&g!==m&&this.vars.onRepeat&&!s&&this.parent&&Hn(this,"onRepeat"),(h===this._tDur||!h)&&this._tTime===h&&(u&&!this._onUpdate&&Dc(this,i,!0,!0),(i||!c)&&(h===this._tDur&&this._ts>0||!h&&this._ts<0)&&lr(this,1),!s&&!(u&&!o)&&(h||o||p)&&(Hn(this,h===l?"onComplete":"onReverseComplete",!0),this._prom&&!(h<l&&this.timeScale()>0)&&this._prom()))}return this},t.targets=function(){return this._targets},t.invalidate=function(i){return(!i||!this.vars.runBackwards)&&(this._startAt=0),this._pt=this._op=this._onUpdate=this._lazy=this.ratio=0,this._ptLookup=[],this.timeline&&this.timeline.invalidate(i),r.prototype.invalidate.call(this,i)},t.resetTo=function(i,s,a,o,l){Ro||kn.wake(),this._ts||this.play();var c=Math.min(this._dur,(this._dp._time-this._start)*this._ts),u;return this._initted||fu(this,c),u=this._ease(c/this._dur),iM(this,i,s,a,o,u,c,l)?this.resetTo(i,s,a,o,1):(al(this,0),this.parent||Kd(this._dp,this,"_first","_last",this._dp._sort?"_start":0),this.render(0))},t.kill=function(i,s){if(s===void 0&&(s="all"),!i&&(!s||s==="all"))return this._lazy=this._pt=0,this.parent?no(this):this;if(this.timeline){var a=this.timeline.totalDuration();return this.timeline.killTweensOf(i,s,ji&&ji.vars.overwrite!==!0)._first||no(this),this.parent&&a!==this.timeline.totalDuration()&&Ns(this,this._dur*this.timeline._tDur/a,0,1),this}var o=this._targets,l=i?Jn(i):o,c=this._ptLookup,u=this._pt,h,f,d,g,_,m,p;if((!s||s==="all")&&IS(o,l))return s==="all"&&(this._pt=0),no(this);for(h=this._op=this._op||[],s!=="all"&&($t(s)&&(_={},wn(s,function(M){return _[M]=1}),s=_),s=rM(o,s)),p=o.length;p--;)if(~l.indexOf(o[p])){f=c[p],s==="all"?(h[p]=s,g=f,d={}):(d=h[p]=h[p]||{},g=s);for(_ in g)m=f&&f[_],m&&((!("kill"in m.d)||m.d.kill(_)===!0)&&sl(this,m,"_pt"),delete f[_]),d!=="all"&&(d[_]=1)}return this._initted&&!this._pt&&u&&no(this),this},e.to=function(i,s){return new e(i,s,arguments[2])},e.from=function(i,s){return go(1,arguments)},e.delayedCall=function(i,s,a,o){return new e(s,0,{immediateRender:!1,lazy:!1,overwrite:!1,delay:i,onComplete:s,onReverseComplete:s,onCompleteParams:a,onReverseCompleteParams:a,callbackScope:o})},e.fromTo=function(i,s,a){return go(2,arguments)},e.set=function(i,s){return s.duration=0,s.repeatDelay||(s.repeat=0),new e(i,s)},e.killTweensOf=function(i,s,a){return At.killTweensOf(i,s,a)},e}(Co);ei(Nt.prototype,{_targets:[],_lazy:0,_startAt:0,_op:0,_onInit:0});wn("staggerTo,staggerFrom,staggerFromTo",function(r){Nt[r]=function(){var e=new vn,t=Ic.call(arguments,0);return t.splice(r==="staggerFromTo"?5:4,0,0),e[r].apply(e,t)}});var du=function(e,t,n){return e[t]=n},vp=function(e,t,n){return e[t](n)},oM=function(e,t,n,i){return e[t](i.fp,n)},aM=function(e,t,n){return e.setAttribute(t,n)},pu=function(e,t){return Ct(e[t])?vp:ru(e[t])&&e.setAttribute?aM:du},xp=function(e,t){return t.set(t.t,t.p,Math.round((t.s+t.c*e)*1e6)/1e6,t)},lM=function(e,t){return t.set(t.t,t.p,!!(t.s+t.c*e),t)},Sp=function(e,t){var n=t._pt,i="";if(!e&&t.b)i=t.b;else if(e===1&&t.e)i=t.e;else{for(;n;)i=n.p+(n.m?n.m(n.s+n.c*e):Math.round((n.s+n.c*e)*1e4)/1e4)+i,n=n._next;i+=t.c}t.set(t.t,t.p,i,t)},mu=function(e,t){for(var n=t._pt;n;)n.r(e,n.d),n=n._next},cM=function(e,t,n,i){for(var s=this._pt,a;s;)a=s._next,s.p===i&&s.modifier(e,t,n),s=a},uM=function(e){for(var t=this._pt,n,i;t;)i=t._next,t.p===e&&!t.op||t.op===e?sl(this,t,"_pt"):t.dep||(n=1),t=i;return!n},hM=function(e,t,n,i){i.mSet(e,t,i.m.call(i.tween,n,i.mt),i)},Mp=function(e){for(var t=e._pt,n,i,s,a;t;){for(n=t._next,i=s;i&&i.pr>t.pr;)i=i._next;(t._prev=i?i._prev:a)?t._prev._next=t:s=t,(t._next=i)?i._prev=t:a=t,t=n}e._pt=s},An=function(){function r(t,n,i,s,a,o,l,c,u){this.t=n,this.s=s,this.c=a,this.p=i,this.r=o||xp,this.d=l||this,this.set=c||du,this.pr=u||0,this._next=t,t&&(t._prev=this)}var e=r.prototype;return e.modifier=function(n,i,s){this.mSet=this.mSet||this.set,this.set=hM,this.m=n,this.mt=s,this.tween=i},r}();wn(cu+"parent,duration,ease,delay,overwrite,runBackwards,startAt,yoyo,immediateRender,repeat,repeatDelay,data,paused,reversed,lazy,callbackScope,stringFilter,id,yoyoEase,stagger,inherit,repeatRefresh,keyframes,autoRevert,scrollTrigger",function(r){return lu[r]=1});Wn.TweenMax=Wn.TweenLite=Nt;Wn.TimelineLite=Wn.TimelineMax=vn;At=new vn({sortChildren:!1,defaults:Us,autoRemoveChildren:!0,id:"root",smoothChildTiming:!0});Vn.stringFilter=up;var Br=[],Da={},fM=[],xf=0,dM=0,tc=function(e){return(Da[e]||fM).map(function(t){return t()})},zc=function(){var e=Date.now(),t=[];e-xf>2&&(tc("matchMediaInit"),Br.forEach(function(n){var i=n.queries,s=n.conditions,a,o,l,c;for(o in i)a=pi.matchMedia(i[o]).matches,a&&(l=1),a!==s[o]&&(s[o]=a,c=1);c&&(n.revert(),l&&t.push(n))}),tc("matchMediaRevert"),t.forEach(function(n){return n.onMatch(n,function(i){return n.add(null,i)})}),xf=e,tc("matchMedia"))},yp=function(){function r(t,n){this.selector=n&&Nc(n),this.data=[],this._r=[],this.isReverted=!1,this.id=dM++,t&&this.add(t)}var e=r.prototype;return e.add=function(n,i,s){Ct(n)&&(s=i,i=n,n=Ct);var a=this,o=function(){var c=Tt,u=a.selector,h;return c&&c!==a&&c.data.push(a),s&&(a.selector=Nc(s)),Tt=a,h=i.apply(a,arguments),Ct(h)&&a._r.push(h),Tt=c,a.selector=u,a.isReverted=!1,h};return a.last=o,n===Ct?o(a,function(l){return a.add(null,l)}):n?a[n]=o:o},e.ignore=function(n){var i=Tt;Tt=null,n(this),Tt=i},e.getTweens=function(){var n=[];return this.data.forEach(function(i){return i instanceof r?n.push.apply(n,i.getTweens()):i instanceof Nt&&!(i.parent&&i.parent.data==="nested")&&n.push(i)}),n},e.clear=function(){this._r.length=this.data.length=0},e.kill=function(n,i){var s=this;if(n?function(){for(var o=s.getTweens(),l=s.data.length,c;l--;)c=s.data[l],c.data==="isFlip"&&(c.revert(),c.getChildren(!0,!0,!1).forEach(function(u){return o.splice(o.indexOf(u),1)}));for(o.map(function(u){return{g:u._dur||u._delay||u._sat&&!u._sat.vars.immediateRender?u.globalTime(0):-1/0,t:u}}).sort(function(u,h){return h.g-u.g||-1/0}).forEach(function(u){return u.t.revert(n)}),l=s.data.length;l--;)c=s.data[l],c instanceof vn?c.data!=="nested"&&(c.scrollTrigger&&c.scrollTrigger.revert(),c.kill()):!(c instanceof Nt)&&c.revert&&c.revert(n);s._r.forEach(function(u){return u(n,s)}),s.isReverted=!0}():this.data.forEach(function(o){return o.kill&&o.kill()}),this.clear(),i)for(var a=Br.length;a--;)Br[a].id===this.id&&Br.splice(a,1)},e.revert=function(n){this.kill(n||{})},r}(),pM=function(){function r(t){this.contexts=[],this.scope=t,Tt&&Tt.data.push(this)}var e=r.prototype;return e.add=function(n,i,s){Mi(n)||(n={matches:n});var a=new yp(0,s||this.scope),o=a.conditions={},l,c,u;Tt&&!a.selector&&(a.selector=Tt.selector),this.contexts.push(a),i=a.add("onMatch",i),a.queries=n;for(c in n)c==="all"?u=1:(l=pi.matchMedia(n[c]),l&&(Br.indexOf(a)<0&&Br.push(a),(o[c]=l.matches)&&(u=1),l.addListener?l.addListener(zc):l.addEventListener("change",zc)));return u&&i(a,function(h){return a.add(null,h)}),this},e.revert=function(n){this.kill(n||{})},e.kill=function(n){this.contexts.forEach(function(i){return i.kill(n,!0)})},r}(),Ka={registerPlugin:function(){for(var e=arguments.length,t=new Array(e),n=0;n<e;n++)t[n]=arguments[n];t.forEach(function(i){return ap(i)})},timeline:function(e){return new vn(e)},getTweensOf:function(e,t){return At.getTweensOf(e,t)},getProperty:function(e,t,n,i){$t(e)&&(e=Jn(e)[0]);var s=Or(e||{}).get,a=n?$d:Yd;return n==="native"&&(n=""),e&&(t?a((Fn[t]&&Fn[t].get||s)(e,t,n,i)):function(o,l,c){return a((Fn[o]&&Fn[o].get||s)(e,o,l,c))})},quickSetter:function(e,t,n){if(e=Jn(e),e.length>1){var i=e.map(function(u){return Cn.quickSetter(u,t,n)}),s=i.length;return function(u){for(var h=s;h--;)i[h](u)}}e=e[0]||{};var a=Fn[t],o=Or(e),l=o.harness&&(o.harness.aliases||{})[t]||t,c=a?function(u){var h=new a;xs._pt=0,h.init(e,n?u+n:u,xs,0,[e]),h.render(1,h),xs._pt&&mu(1,xs)}:o.set(e,l);return a?c:function(u){return c(e,l,n?u+n:u,o,1)}},quickTo:function(e,t,n){var i,s=Cn.to(e,qr((i={},i[t]="+=0.1",i.paused=!0,i),n||{})),a=function(l,c,u){return s.resetTo(t,l,c,u)};return a.tween=s,a},isTweening:function(e){return At.getTweensOf(e,!0).length>0},defaults:function(e){return e&&e.ease&&(e.ease=zr(e.ease,Us.ease)),pf(Us,e||{})},config:function(e){return pf(Vn,e||{})},registerEffect:function(e){var t=e.name,n=e.effect,i=e.plugins,s=e.defaults,a=e.extendTimeline;(i||"").split(",").forEach(function(o){return o&&!Fn[o]&&!Wn[o]&&bo(t+" effect requires "+o+" plugin.")}),jl[t]=function(o,l,c){return n(Jn(o),ei(l||{},s),c)},a&&(vn.prototype[t]=function(o,l,c){return this.add(jl[t](o,Mi(l)?l:(c=l)&&{},this),c)})},registerEase:function(e,t){ot[e]=zr(t)},parseEase:function(e,t){return arguments.length?zr(e,t):ot},getById:function(e){return At.getById(e)},exportRoot:function(e,t){e===void 0&&(e={});var n=new vn(e),i,s;for(n.smoothChildTiming=bn(e.smoothChildTiming),At.remove(n),n._dp=0,n._time=n._tTime=At._time,i=At._first;i;)s=i._next,(t||!(!i._dur&&i instanceof Nt&&i.vars.onComplete===i._targets[0]))&&_i(n,i,i._start-i._delay),i=s;return _i(At,n,0),n},context:function(e,t){return e?new yp(e,t):Tt},matchMedia:function(e){return new pM(e)},matchMediaRefresh:function(){return Br.forEach(function(e){var t=e.conditions,n,i;for(i in t)t[i]&&(t[i]=!1,n=1);n&&e.revert()})||zc()},addEventListener:function(e,t){var n=Da[e]||(Da[e]=[]);~n.indexOf(t)||n.push(t)},removeEventListener:function(e,t){var n=Da[e],i=n&&n.indexOf(t);i>=0&&n.splice(i,1)},utils:{wrap:qS,wrapYoyo:YS,distribute:tp,random:ip,snap:np,normalize:XS,getUnit:nn,clamp:HS,splitColor:lp,toArray:Jn,selector:Nc,mapRange:sp,pipe:VS,unitize:WS,interpolate:$S,shuffle:ep},install:Gd,effects:jl,ticker:kn,updateRoot:vn.updateRoot,plugins:Fn,globalTimeline:At,core:{PropTween:An,globals:Vd,Tween:Nt,Timeline:vn,Animation:Co,getCache:Or,_removeLinkedListItem:sl,reverting:function(){return rn},context:function(e){return e&&Tt&&(Tt.data.push(e),e._ctx=Tt),Tt},suppressOverwrites:function(e){return iu=e}}};wn("to,from,fromTo,delayedCall,set,killTweensOf",function(r){return Ka[r]=Nt[r]});kn.add(vn.updateRoot);xs=Ka.to({},{duration:0});var mM=function(e,t){for(var n=e._pt;n&&n.p!==t&&n.op!==t&&n.fp!==t;)n=n._next;return n},_M=function(e,t){var n=e._targets,i,s,a;for(i in t)for(s=n.length;s--;)a=e._ptLookup[s][i],a&&(a=a.d)&&(a._pt&&(a=mM(a,i)),a&&a.modifier&&a.modifier(t[i],e,n[s],i))},nc=function(e,t){return{name:e,rawVars:1,init:function(i,s,a){a._onInit=function(o){var l,c;if($t(s)&&(l={},wn(s,function(u){return l[u]=1}),s=l),t){l={};for(c in s)l[c]=t(s[c]);s=l}_M(o,s)}}}},Cn=Ka.registerPlugin({name:"attr",init:function(e,t,n,i,s){var a,o,l;this.tween=n;for(a in t)l=e.getAttribute(a)||"",o=this.add(e,"setAttribute",(l||0)+"",t[a],i,s,0,0,a),o.op=a,o.b=l,this._props.push(a)},render:function(e,t){for(var n=t._pt;n;)rn?n.set(n.t,n.p,n.b,n):n.r(e,n.d),n=n._next}},{name:"endArray",init:function(e,t){for(var n=t.length;n--;)this.add(e,n,e[n]||0,t[n],0,0,0,0,0,1)}},nc("roundProps",Oc),nc("modifiers"),nc("snap",np))||Ka;Nt.version=vn.version=Cn.version="3.12.5";Hd=1;su()&&Os();ot.Power0;ot.Power1;ot.Power2;ot.Power3;ot.Power4;ot.Linear;ot.Quad;ot.Cubic;ot.Quart;ot.Quint;ot.Strong;ot.Elastic;ot.Back;ot.SteppedEase;ot.Bounce;ot.Sine;ot.Expo;ot.Circ;/*!
 * CSSPlugin 3.12.5
 * https://gsap.com
 *
 ...
 * Club GSAP members, the agreement issued with that membership.
 * @author: Jack Doyle, jack@greensock.com
*/var Sf,Ji,ws,_u,Ar,Mf,gu,gM=function(){return typeof window<"u"},Bi={},Er=180/Math.PI,As=Math.PI/180,ds=Math.atan2,yf=1e8,vu=/([A-Z])/g,vM=/(left|right|width|margin|padding|x)/i,xM=/[\s,\(]\S/,vi={autoAlpha:"opacity,visibility",scale:"scaleX,scaleY",alpha:"opacity"},Bc=function(e,t){return t.set(t.t,t.p,Math.round((t.s+t.c*e)*1e4)/1e4+t.u,t)},SM=function(e,t){return t.set(t.t,t.p,e===1?t.e:Math.round((t.s+t.c*e)*1e4)/1e4+t.u,t)},MM=function(e,t){return t.set(t.t,t.p,e?Math.round((t.s+t.c*e)*1e4)/1e4+t.u:t.b,t)},yM=function(e,t){var n=t.s+t.c*e;t.set(t.t,t.p,~~(n+(n<0?-.5:.5))+t.u,t)},Ep=function(e,t){return t.set(t.t,t.p,e?t.e:t.b,t)},Tp=function(e,t){return t.set(t.t,t.p,e!==1?t.b:t.e,t)},EM=function(e,t,n){return e.style[t]=n},TM=function(e,t,n){return e.style.setProperty(t,n)},bM=function(e,t,n){return e._gsap[t]=n},wM=function(e,t,n){return e._gsap.scaleX=e._gsap.scaleY=n},AM=function(e,t,n,i,s){var a=e._gsap;a.scaleX=a.scaleY=n,a.renderTransform(s,a)},RM=function(e,t,n,i,s){var a=e._gsap;a[t]=n,a.renderTransform(s,a)},Rt="transform",Rn=Rt+"Origin",CM=function r(e,t){var n=this,i=this.target,s=i.style,a=i._gsap;if(e in Bi&&s){if(this.tfm=this.tfm||{},e!=="transform")e=vi[e]||e,~e.indexOf(",")?e.split(",").forEach(function(o){return n.tfm[o]=Li(i,o)}):this.tfm[e]=a.x?a[e]:Li(i,e),e===Rn&&(this.tfm.zOrigin=a.zOrigin);else return vi.transform.split(",").forEach(function(o){return r.call(n,o,t)});if(this.props.indexOf(Rt)>=0)return;a.svg&&(this.svgo=i.getAttribute("data-svg-origin"),this.props.push(Rn,t,"")),e=Rt}(s||t)&&this.props.push(e,t,s[e])},bp=function(e){e.translate&&(e.removeProperty("translate"),e.removeProperty("scale"),e.removeProperty("rotate"))},PM=function(){var e=this.props,t=this.target,n=t.style,i=t._gsap,s,a;for(s=0;s<e.length;s+=3)e[s+1]?t[e[s]]=e[s+2]:e[s+2]?n[e[s]]=e[s+2]:n.removeProperty(e[s].substr(0,2)==="--"?e[s]:e[s].replace(vu,"-$1").toLowerCase());if(this.tfm){for(a in this.tfm)i[a]=this.tfm[a];i.svg&&(i.renderTransform(),t.setAttribute("data-svg-origin",this.svgo||"")),s=gu(),(!s||!s.isStart)&&!n[Rt]&&(bp(n),i.zOrigin&&n[Rn]&&(n[Rn]+=" "+i.zOrigin+"px",i.zOrigin=0,i.renderTransform()),i.uncache=1)}},wp=function(e,t){var n={target:e,props:[],revert:PM,save:CM};return e._gsap||Cn.core.getCache(e),t&&t.split(",").forEach(function(i){return n.save(i)}),n},Ap,kc=function(e,t){var n=Ji.createElementNS?Ji.createElementNS((t||"http://www.w3.org/1999/xhtml").replace(/^https/,"http"),e):Ji.createElement(e);return n&&n.style?n:Ji.createElement(e)},Si=function r(e,t,n){var i=getComputedStyle(e);return i[t]||i.getPropertyValue(t.replace(vu,"-$1").toLowerCase())||i.getPropertyValue(t)||!n&&r(e,Fs(t)||t,1)||""},Ef="O,Moz,ms,Ms,Webkit".split(","),Fs=function(e,t,n){var i=t||Ar,s=i.style,a=5;if(e in s&&!n)return e;for(e=e.charAt(0).toUpperCase()+e.substr(1);a--&&!(Ef[a]+e in s););return a<0?null:(a===3?"ms":a>=0?Ef[a]:"")+e},Hc=function(){gM()&&window.document&&(Sf=window,Ji=Sf.document,ws=Ji.documentElement,Ar=kc("div")||{style:{}},kc("div"),Rt=Fs(Rt),Rn=Rt+"Origin",Ar.style.cssText="border-width:0;line-height:0;position:absolute;padding:0",Ap=!!Fs("perspective"),gu=Cn.core.reverting,_u=1)},ic=function r(e){var t=kc("svg",this.ownerSVGElement&&this.ownerSVGElement.getAttribute("xmlns")||"http://www.w3.org/2000/svg"),n=this.parentNode,i=this.nextSibling,s=this.style.cssText,a;if(ws.appendChild(t),t.appendChild(this),this.style.display="block",e)try{a=this.getBBox(),this._gsapBBox=this.getBBox,this.getBBox=r}catch{}else this._gsapBBox&&(a=this._gsapBBox());return n&&(i?n.insertBefore(this,i):n.appendChild(this)),ws.removeChild(t),this.style.cssText=s,a},Tf=function(e,t){for(var n=t.length;n--;)if(e.hasAttribute(t[n]))return e.getAttribute(t[n])},Rp=function(e){var t;try{t=e.getBBox()}catch{t=ic.call(e,!0)}return t&&(t.width||t.height)||e.getBBox===ic||(t=ic.call(e,!0)),t&&!t.width&&!t.x&&!t.y?{x:+Tf(e,["x","cx","x1"])||0,y:+Tf(e,["y","cy","y1"])||0,width:0,height:0}:t},Cp=function(e){return!!(e.getCTM&&(!e.parentNode||e.ownerSVGElement)&&Rp(e))},Yr=function(e,t){if(t){var n=e.style,i;t in Bi&&t!==Rn&&(t=Rt),n.removeProperty?(i=t.substr(0,2),(i==="ms"||t.substr(0,6)==="webkit")&&(t="-"+t),n.removeProperty(i==="--"?t:t.replace(vu,"-$1").toLowerCase())):n.removeAttribute(t)}},Qi=function(e,t,n,i,s,a){var o=new An(e._pt,t,n,0,1,a?Tp:Ep);return e._pt=o,o.b=i,o.e=s,e._props.push(n),o},bf={deg:1,rad:1,turn:1},LM={grid:1,flex:1},cr=function r(e,t,n,i){var s=parseFloat(n)||0,a=(n+"").trim().substr((s+"").length)||"px",o=Ar.style,l=vM.test(t),c=e.tagName.toLowerCase()==="svg",u=(c?"client":"offset")+(l?"Width":"Height"),h=100,f=i==="px",d=i==="%",g,_,m,p;if(i===a||!s||bf[i]||bf[a])return s;if(a!=="px"&&!f&&(s=r(e,t,n,"px")),p=e.getCTM&&Cp(e),(d||a==="%")&&(Bi[t]||~t.indexOf("adius")))return g=p?e.getBBox()[l?"width":"height"]:e[u],Pt(d?s/g*h:s/100*g);if(o[l?"width":"height"]=h+(f?a:i),_=~t.indexOf("adius")||i==="em"&&e.appendChild&&!c?e:e.parentNode,p&&(_=(e.ownerSVGElement||{}).parentNode),(!_||_===Ji||!_.appendChild)&&(_=Ji.body),m=_._gsap,m&&d&&m.width&&l&&m.time===kn.time&&!m.uncache)return Pt(s/m.width*h);if(d&&(t==="height"||t==="width")){var M=e.style[t];e.style[t]=h+i,g=e[u],M?e.style[t]=M:Yr(e,t)}else(d||a==="%")&&!LM[Si(_,"display")]&&(o.position=Si(e,"position")),_===e&&(o.position="static"),_.appendChild(Ar),g=Ar[u],_.removeChild(Ar),o.position="absolute";return l&&d&&(m=Or(_),m.time=kn.time,m.width=_[u]),Pt(f?g*s/h:g&&s?h/g*s:0)},Li=function(e,t,n,i){var s;return _u||Hc(),t in vi&&t!=="transform"&&(t=vi[t],~t.indexOf(",")&&(t=t.split(",")[0])),Bi[t]&&t!=="transform"?(s=Lo(e,i),s=t!=="transformOrigin"?s[t]:s.svg?s.origin:ja(Si(e,Rn))+" "+s.zOrigin+"px"):(s=e.style[t],(!s||s==="auto"||i||~(s+"").indexOf("calc("))&&(s=Za[t]&&Za[t](e,t,n)||Si(e,t)||Xd(e,t)||(t==="opacity"?1:0))),n&&!~(s+"").trim().indexOf(" ")?cr(e,t,s,n)+n:s},DM=function(e,t,n,i){if(!n||n==="none"){var s=Fs(t,e,1),a=s&&Si(e,s,1);a&&a!==n?(t=s,n=a):t==="borderColor"&&(n=Si(e,"borderTopColor"))}var o=new An(this._pt,e.style,t,0,1,Sp),l=0,c=0,u,h,f,d,g,_,m,p,M,v,S,E;if(o.b=n,o.e=i,n+="",i+="",i==="auto"&&(_=e.style[t],e.style[t]=i,i=Si(e,t)||i,_?e.style[t]=_:Yr(e,t)),u=[n,i],up(u),n=u[0],i=u[1],f=n.match(vs)||[],E=i.match(vs)||[],E.length){for(;h=vs.exec(i);)m=h[0],M=i.substring(l,h.index),g?g=(g+1)%5:(M.substr(-5)==="rgba("||M.substr(-5)==="hsla(")&&(g=1),m!==(_=f[c++]||"")&&(d=parseFloat(_)||0,S=_.substr((d+"").length),m.charAt(1)==="="&&(m=bs(d,m)+S),p=parseFloat(m),v=m.substr((p+"").length),l=vs.lastIndex-v.length,v||(v=v||Vn.units[t]||S,l===i.length&&(i+=v,o.e+=v)),S!==v&&(d=cr(e,t,_,v)||0),o._pt={_next:o._pt,p:M||c===1?M:",",s:d,c:p-d,m:g&&g<4||t==="zIndex"?Math.round:0});o.c=l<i.length?i.substring(l,i.length):""}else o.r=t==="display"&&i==="none"?Tp:Ep;return Bd.test(i)&&(o.e=0),this._pt=o,o},wf={top:"0%",bottom:"100%",left:"0%",right:"100%",center:"50%"},UM=function(e){var t=e.split(" "),n=t[0],i=t[1]||"50%";return(n==="top"||n==="bottom"||i==="left"||i==="right")&&(e=n,n=i,i=e),t[0]=wf[n]||n,t[1]=wf[i]||i,t.join(" ")},IM=function(e,t){if(t.tween&&t.tween._time===t.tween._dur){var n=t.t,i=n.style,s=t.u,a=n._gsap,o,l,c;if(s==="all"||s===!0)i.cssText="",l=1;else for(s=s.split(","),c=s.length;--c>-1;)o=s[c],Bi[o]&&(l=1,o=o==="transformOrigin"?Rn:Rt),Yr(n,o);l&&(Yr(n,Rt),a&&(a.svg&&n.removeAttribute("transform"),Lo(n,1),a.uncache=1,bp(i)))}},Za={clearProps:function(e,t,n,i,s){if(s.data!=="isFromStart"){var a=e._pt=new An(e._pt,t,n,0,0,IM);return a.u=i,a.pr=-10,a.tween=s,e._props.push(n),1}}},Po=[1,0,0,1,0,0],Pp={},Lp=function(e){return e==="matrix(1, 0, 0, 1, 0, 0)"||e==="none"||!e},Af=function(e){var t=Si(e,Rt);return Lp(t)?Po:t.substr(7).match(zd).map(Pt)},xu=function(e,t){var n=e._gsap||Or(e),i=e.style,s=Af(e),a,o,l,c;return n.svg&&e.getAttribute("transform")?(l=e.transform.baseVal.consolidate().matrix,s=[l.a,l.b,l.c,l.d,l.e,l.f],s.join(",")==="1,0,0,1,0,0"?Po:s):(s===Po&&!e.offsetParent&&e!==ws&&!n.svg&&(l=i.display,i.display="block",a=e.parentNode,(!a||!e.offsetParent)&&(c=1,o=e.nextElementSibling,ws.appendChild(e)),s=Af(e),l?i.display=l:Yr(e,"display"),c&&(o?a.insertBefore(e,o):a?a.appendChild(e):ws.removeChild(e))),t&&s.length>6?[s[0],s[1],s[4],s[5],s[12],s[13]]:s)},Gc=function(e,t,n,i,s,a){var o=e._gsap,l=s||xu(e,!0),c=o.xOrigin||0,u=o.yOrigin||0,h=o.xOffset||0,f=o.yOffset||0,d=l[0],g=l[1],_=l[2],m=l[3],p=l[4],M=l[5],v=t.split(" "),S=parseFloat(v[0])||0,E=parseFloat(v[1])||0,A,w,D,x;n?l!==Po&&(w=d*m-g*_)&&(D=S*(m/w)+E*(-_/w)+(_*M-m*p)/w,x=S*(-g/w)+E*(d/w)-(d*M-g*p)/w,S=D,E=x):(A=Rp(e),S=A.x+(~v[0].indexOf("%")?S/100*A.width:S),E=A.y+(~(v[1]||v[0]).indexOf("%")?E/100*A.height:E)),i||i!==!1&&o.smooth?(p=S-c,M=E-u,o.xOffset=h+(p*d+M*_)-p,o.yOffset=f+(p*g+M*m)-M):o.xOffset=o.yOffset=0,o.xOrigin=S,o.yOrigin=E,o.smooth=!!i,o.origin=t,o.originIsAbsolute=!!n,e.style[Rn]="0px 0px",a&&(Qi(a,o,"xOrigin",c,S),Qi(a,o,"yOrigin",u,E),Qi(a,o,"xOffset",h,o.xOffset),Qi(a,o,"yOffset",f,o.yOffset)),e.setAttribute("data-svg-origin",S+" "+E)},Lo=function(e,t){var n=e._gsap||new pp(e);if("x"in n&&!t&&!n.uncache)return n;var i=e.style,s=n.scaleX<0,a="px",o="deg",l=getComputedStyle(e),c=Si(e,Rn)||"0",u,h,f,d,g,_,m,p,M,v,S,E,A,w,D,x,b,F,N,Z,P,z,q,O,j,Y,R,U,$,ue,oe,he;return u=h=f=_=m=p=M=v=S=0,d=g=1,n.svg=!!(e.getCTM&&Cp(e)),l.translate&&((l.translate!=="none"||l.scale!=="none"||l.rotate!=="none")&&(i[Rt]=(l.translate!=="none"?"translate3d("+(l.translate+" 0 0").split(" ").slice(0,3).join(", ")+") ":"")+(l.rotate!=="none"?"rotate("+l.rotate+") ":"")+(l.scale!=="none"?"scale("+l.scale.split(" ").join(",")+") ":"")+(l[Rt]!=="none"?l[Rt]:"")),i.scale=i.rotate=i.translate="none"),w=xu(e,n.svg),n.svg&&(n.uncache?(j=e.getBBox(),c=n.xOrigin-j.x+"px "+(n.yOrigin-j.y)+"px",O=""):O=!t&&e.getAttribute("data-svg-origin"),Gc(e,O||c,!!O||n.originIsAbsolute,n.smooth!==!1,w)),E=n.xOrigin||0,A=n.yOrigin||0,w!==Po&&(F=w[0],N=w[1],Z=w[2],P=w[3],u=z=w[4],h=q=w[5],w.length===6?(d=Math.sqrt(F*F+N*N),g=Math.sqrt(P*P+Z*Z),_=F||N?ds(N,F)*Er:0,M=Z||P?ds(Z,P)*Er+_:0,M&&(g*=Math.abs(Math.cos(M*As))),n.svg&&(u-=E-(E*F+A*Z),h-=A-(E*N+A*P))):(he=w[6],ue=w[7],R=w[8],U=w[9],$=w[10],oe=w[11],u=w[12],h=w[13],f=w[14],D=ds(he,$),m=D*Er,D&&(x=Math.cos(-D),b=Math.sin(-D),O=z*x+R*b,j=q*x+U*b,Y=he*x+$*b,R=z*-b+R*x,U=q*-b+U*x,$=he*-b+$*x,oe=ue*-b+oe*x,z=O,q=j,he=Y),D=ds(-Z,$),p=D*Er,D&&(x=Math.cos(-D),b=Math.sin(-D),O=F*x-R*b,j=N*x-U*b,Y=Z*x-$*b,oe=P*b+oe*x,F=O,N=j,Z=Y),D=ds(N,F),_=D*Er,D&&(x=Math.cos(D),b=Math.sin(D),O=F*x+N*b,j=z*x+q*b,N=N*x-F*b,q=q*x-z*b,F=O,z=j),m&&Math.abs(m)+Math.abs(_)>359.9&&(m=_=0,p=180-p),d=Pt(Math.sqrt(F*F+N*N+Z*Z)),g=Pt(Math.sqrt(q*q+he*he)),D=ds(z,q),M=Math.abs(D)>2e-4?D*Er:0,S=oe?1/(oe<0?-oe:oe):0),n.svg&&(O=e.getAttribute("transform"),n.forceCSS=e.setAttribute("transform","")||!Lp(Si(e,Rt)),O&&e.setAttribute("transform",O))),Math.abs(M)>90&&Math.abs(M)<270&&(s?(d*=-1,M+=_<=0?180:-180,_+=_<=0?180:-180):(g*=-1,M+=M<=0?180:-180)),t=t||n.uncache,n.x=u-((n.xPercent=u&&(!t&&n.xPercent||(Math.round(e.offsetWidth/2)===Math.round(-u)?-50:0)))?e.offsetWidth*n.xPercent/100:0)+a,n.y=h-((n.yPercent=h&&(!t&&n.yPercent||(Math.round(e.offsetHeight/2)===Math.round(-h)?-50:0)))?e.offsetHeight*n.yPercent/100:0)+a,n.z=f+a,n.scaleX=Pt(d),n.scaleY=Pt(g),n.rotation=Pt(_)+o,n.rotationX=Pt(m)+o,n.rotationY=Pt(p)+o,n.skewX=M+o,n.skewY=v+o,n.transformPerspective=S+a,(n.zOrigin=parseFloat(c.split(" ")[2])||!t&&n.zOrigin||0)&&(i[Rn]=ja(c)),n.xOffset=n.yOffset=0,n.force3D=Vn.force3D,n.renderTransform=n.svg?OM:Ap?Dp:NM,n.uncache=0,n},ja=function(e){return(e=e.split(" "))[0]+" "+e[1]},rc=function(e,t,n){var i=nn(t);return Pt(parseFloat(t)+parseFloat(cr(e,"x",n+"px",i)))+i},NM=function(e,t){t.z="0px",t.rotationY=t.rotationX="0deg",t.force3D=0,Dp(e,t)},gr="0deg",$s="0px",vr=") ",Dp=function(e,t){var n=t||this,i=n.xPercent,s=n.yPercent,a=n.x,o=n.y,l=n.z,c=n.rotation,u=n.rotationY,h=n.rotationX,f=n.skewX,d=n.skewY,g=n.scaleX,_=n.scaleY,m=n.transformPerspective,p=n.force3D,M=n.target,v=n.zOrigin,S="",E=p==="auto"&&e&&e!==1||p===!0;if(v&&(h!==gr||u!==gr)){var A=parseFloat(u)*As,w=Math.sin(A),D=Math.cos(A),x;A=parseFloat(h)*As,x=Math.cos(A),a=rc(M,a,w*x*-v),o=rc(M,o,-Math.sin(A)*-v),l=rc(M,l,D*x*-v+v)}m!==$s&&(S+="perspective("+m+vr),(i||s)&&(S+="translate("+i+"%, "+s+"%) "),(E||a!==$s||o!==$s||l!==$s)&&(S+=l!==$s||E?"translate3d("+a+", "+o+", "+l+") ":"translate("+a+", "+o+vr),c!==gr&&(S+="rotate("+c+vr),u!==gr&&(S+="rotateY("+u+vr),h!==gr&&(S+="rotateX("+h+vr),(f!==gr||d!==gr)&&(S+="skew("+f+", "+d+vr),(g!==1||_!==1)&&(S+="scale("+g+", "+_+vr),M.style[Rt]=S||"translate(0, 0)"},OM=function(e,t){var n=t||this,i=n.xPercent,s=n.yPercent,a=n.x,o=n.y,l=n.rotation,c=n.skewX,u=n.skewY,h=n.scaleX,f=n.scaleY,d=n.target,g=n.xOrigin,_=n.yOrigin,m=n.xOffset,p=n.yOffset,M=n.forceCSS,v=parseFloat(a),S=parseFloat(o),E,A,w,D,x;l=parseFloat(l),c=parseFloat(c),u=parseFloat(u),u&&(u=parseFloat(u),c+=u,l+=u),l||c?(l*=As,c*=As,E=Math.cos(l)*h,A=Math.sin(l)*h,w=Math.sin(l-c)*-f,D=Math.cos(l-c)*f,c&&(u*=As,x=Math.tan(c-u),x=Math.sqrt(1+x*x),w*=x,D*=x,u&&(x=Math.tan(u),x=Math.sqrt(1+x*x),E*=x,A*=x)),E=Pt(E),A=Pt(A),w=Pt(w),D=Pt(D)):(E=h,D=f,A=w=0),(v&&!~(a+"").indexOf("px")||S&&!~(o+"").indexOf("px"))&&(v=cr(d,"x",a,"px"),S=cr(d,"y",o,"px")),(g||_||m||p)&&(v=Pt(v+g-(g*E+_*w)+m),S=Pt(S+_-(g*A+_*D)+p)),(i||s)&&(x=d.getBBox(),v=Pt(v+i/100*x.width),S=Pt(S+s/100*x.height)),x="matrix("+E+","+A+","+w+","+D+","+v+","+S+")",d.setAttribute("transform",x),M&&(d.style[Rt]=x)},FM=function(e,t,n,i,s){var a=360,o=$t(s),l=parseFloat(s)*(o&&~s.indexOf("rad")?Er:1),c=l-i,u=i+c+"deg",h,f;return o&&(h=s.split("_")[1],h==="short"&&(c%=a,c!==c%(a/2)&&(c+=c<0?a:-a)),h==="cw"&&c<0?c=(c+a*yf)%a-~~(c/a)*a:h==="ccw"&&c>0&&(c=(c-a*yf)%a-~~(c/a)*a)),e._pt=f=new An(e._pt,t,n,i,c,SM),f.e=u,f.u="deg",e._props.push(n),f},Rf=function(e,t){for(var n in t)e[n]=t[n];return e},zM=function(e,t,n){var i=Rf({},n._gsap),s="perspective,force3D,transformOrigin,svgOrigin",a=n.style,o,l,c,u,h,f,d,g;i.svg?(c=n.getAttribute("transform"),n.setAttribute("transform",""),a[Rt]=t,o=Lo(n,1),Yr(n,Rt),n.setAttribute("transform",c)):(c=getComputedStyle(n)[Rt],a[Rt]=t,o=Lo(n,1),a[Rt]=c);for(l in Bi)c=i[l],u=o[l],c!==u&&s.indexOf(l)<0&&(d=nn(c),g=nn(u),h=d!==g?cr(n,l,c,g):parseFloat(c),f=parseFloat(u),e._pt=new An(e._pt,o,l,h,f-h,Bc),e._pt.u=g||0,e._props.push(l));Rf(o,i)};wn("padding,margin,Width,Radius",function(r,e){var t="Top",n="Right",i="Bottom",s="Left",a=(e<3?[t,n,i,s]:[t+s,t+n,i+n,i+s]).map(function(o){return e<2?r+o:"border"+o+r});Za[e>1?"border"+r:r]=function(o,l,c,u,h){var f,d;if(arguments.length<4)return f=a.map(function(g){return Li(o,g,c)}),d=f.join(" "),d.split(f[0]).length===5?f[0]:d;f=(u+"").split(" "),d={},a.forEach(function(g,_){return d[g]=f[_]=f[_]||f[(_-1)/2|0]}),o.init(l,d,h)}});var Up={name:"css",register:Hc,targetTest:function(e){return e.style&&e.nodeType},init:function(e,t,n,i,s){var a=this._props,o=e.style,l=n.vars.startAt,c,u,h,f,d,g,_,m,p,M,v,S,E,A,w,D;_u||Hc(),this.styles=this.styles||wp(e),D=this.styles.props,this.tween=n;for(_ in t)if(_!=="autoRound"&&(u=t[_],!(Fn[_]&&mp(_,t,n,i,e,s)))){if(d=typeof u,g=Za[_],d==="function"&&(u=u.call(n,i,e,s),d=typeof u),d==="string"&&~u.indexOf("random(")&&(u=Ao(u)),g)g(this,e,_,u,n)&&(w=1);else if(_.substr(0,2)==="--")c=(getComputedStyle(e).getPropertyValue(_)+"").trim(),u+="",sr.lastIndex=0,sr.test(c)||(m=nn(c),p=nn(u)),p?m!==p&&(c=cr(e,_,c,p)+p):m&&(u+=m),this.add(o,"setProperty",c,u,i,s,0,0,_),a.push(_),D.push(_,0,o[_]);else if(d!=="undefined"){if(l&&_ in l?(c=typeof l[_]=="function"?l[_].call(n,i,e,s):l[_],$t(c)&&~c.indexOf("random(")&&(c=Ao(c)),nn(c+"")||c==="auto"||(c+=Vn.units[_]||nn(Li(e,_))||""),(c+"").charAt(1)==="="&&(c=Li(e,_))):c=Li(e,_),f=parseFloat(c),M=d==="string"&&u.charAt(1)==="="&&u.substr(0,2),M&&(u=u.substr(2)),h=parseFloat(u),_ in vi&&(_==="autoAlpha"&&(f===1&&Li(e,"visibility")==="hidden"&&h&&(f=0),D.push("visibility",0,o.visibility),Qi(this,o,"visibility",f?"inherit":"hidden",h?"inherit":"hidden",!h)),_!=="scale"&&_!=="transform"&&(_=vi[_],~_.indexOf(",")&&(_=_.split(",")[0]))),v=_ in Bi,v){if(this.styles.save(_),S||(E=e._gsap,E.renderTransform&&!t.parseTransform||Lo(e,t.parseTransform),A=t.smoothOrigin!==!1&&E.smooth,S=this._pt=new An(this._pt,o,Rt,0,1,E.renderTransform,E,0,-1),S.dep=1),_==="scale")this._pt=new An(this._pt,E,"scaleY",E.scaleY,(M?bs(E.scaleY,M+h):h)-E.scaleY||0,Bc),this._pt.u=0,a.push("scaleY",_),_+="X";else if(_==="transformOrigin"){D.push(Rn,0,o[Rn]),u=UM(u),E.svg?Gc(e,u,0,A,0,this):(p=parseFloat(u.split(" ")[2])||0,p!==E.zOrigin&&Qi(this,E,"zOrigin",E.zOrigin,p),Qi(this,o,_,ja(c),ja(u)));continue}else if(_==="svgOrigin"){Gc(e,u,1,A,0,this);continue}else if(_ in Pp){FM(this,E,_,f,M?bs(f,M+u):u);continue}else if(_==="smoothOrigin"){Qi(this,E,"smooth",E.smooth,u);continue}else if(_==="force3D"){E[_]=u;continue}else if(_==="transform"){zM(this,u,e);continue}}else _ in o||(_=Fs(_)||_);if(v||(h||h===0)&&(f||f===0)&&!xM.test(u)&&_ in o)m=(c+"").substr((f+"").length),h||(h=0),p=nn(u)||(_ in Vn.units?Vn.units[_]:m),m!==p&&(f=cr(e,_,c,p)),this._pt=new An(this._pt,v?E:o,_,f,(M?bs(f,M+h):h)-f,!v&&(p==="px"||_==="zIndex")&&t.autoRound!==!1?yM:Bc),this._pt.u=p||0,m!==p&&p!=="%"&&(this._pt.b=c,this._pt.r=MM);else if(_ in o)DM.call(this,e,_,c,M?M+u:u);else if(_ in e)this.add(e,_,c||e[_],M?M+u:u,i,s);else if(_!=="parseTransform"){au(_,u);continue}v||(_ in o?D.push(_,0,o[_]):D.push(_,1,c||e[_])),a.push(_)}}w&&Mp(this)},render:function(e,t){if(t.tween._time||!gu())for(var n=t._pt;n;)n.r(e,n.d),n=n._next;else t.styles.revert()},get:Li,aliases:vi,getSetter:function(e,t,n){var i=vi[t];return i&&i.indexOf(",")<0&&(t=i),t in Bi&&t!==Rn&&(e._gsap.x||Li(e,"x"))?n&&Mf===n?t==="scale"?wM:bM:(Mf=n||{})&&(t==="scale"?AM:RM):e.style&&!ru(e.style[t])?EM:~t.indexOf("-")?TM:pu(e,t)},core:{_removeProperty:Yr,_getMatrix:xu}};Cn.utils.checkPrefix=Fs;Cn.core.getStyleSaver=wp;(function(r,e,t,n){var i=wn(r+","+e+","+t,function(s){Bi[s]=1});wn(e,function(s){Vn.units[s]="deg",Pp[s]=1}),vi[i[13]]=r+","+e,wn(n,function(s){var a=s.split(":");vi[a[1]]=i[a[0]]})})("x,y,z,scale,scaleX,scaleY,xPercent,yPercent","rotation,rotationX,rotationY,skewX,skewY","transform,transformOrigin,svgOrigin,force3D,smoothOrigin,transformPerspective","0:translateX,1:translateY,2:translateZ,8:rotate,8:rotationZ,8:rotateZ,9:rotateX,10:rotateY");wn("x,y,z,top,right,bottom,left,width,height,fontSize,padding,margin,perspective",function(r){Vn.units[r]="px"});Cn.registerPlugin(Up);var ht=Cn.registerPlugin(Up)||Cn;ht.core.Tween;function BM(){return new Worker(""+new URL("generateGalaxyWorker-ac2c9d7b.js",import.meta.url).href)}ht.registerPlugin(Qe);const kM=document.querySelector("canvas.webgl"),Do=new Jx,Ip=new nS,HM=Ip.load("./textures/particles/8.png"),GM=Ip.load("./textures/particles/4.png"),Np=500,Ua=new Float32Array(Np*3);for(let r=0;r<Np;r++)Ua[r*3+0]=(Math.random()-.5)*10,Ua[r*3+1]=.5-Math.random()*8,Ua[r*3+2]=(Math.random()-.5)*10;const Op=new ui;Op.setAttribute("position",new Gn(Ua,3));const VM=new $c({color:"#ffffff",size:.08,blending:Ia,alphaMap:GM,transparent:!0,depthWrite:!1,sizeAttenuation:!0,transparent:!0}),kr=new ad(Op,VM);let Ge={count:9e4,size:.01,radius:1.5,branches:3,spin:0,randomness:.5,randomnessPower:10,insideColor:"#312eff",outsideColor:"#1b8360",position:{x:0,y:2,z:0}};window.innerWidth<=768?Ge={count:4e4,size:.03,radius:1,branches:3,spin:0,randomness:.5,randomnessPower:10,insideColor:"#312eff",outsideColor:"#1b8360",position:{x:0,y:2,z:0}}:Ge={count:9e4,size:.01,radius:1.5,branches:3,spin:0,randomness:.5,randomnessPower:10,insideColor:"#312eff",outsideColor:"#1b8360",position:{x:0,y:2,z:0}};const Fp=[];let Rr=4;window.innerWidth<=768?Rr=2:Rr=4;let Cf={};for(let r=0;r<Rr;r++)Fp.push(new BM);let ri=new ui,sc=null,Pi=null;const zp=()=>{const r={count:Ge.count,maxRadius:Ge.radius,branches:Ge.branches,spin:Ge.spin,randomnessPower:Ge.randomnessPower,insideColor:Ge.insideColor,outsideColor:Ge.outsideColor};let e=0;Pi!==null&&(Do.remove(Pi),ri.dispose(),sc.dispose(),Pi=null);const t=new Float32Array(Ge.count*3),n=new Float32Array(Ge.count*3);ri=new ui,ri.setAttribute("position",new Gn(t,3)),ri.setAttribute("color",new Gn(n,3)),Fp.forEach((s,a)=>{const o=Math.floor(a*Ge.count/Rr),l=Math.floor((a+1)*Ge.count/Rr),c={...r,startIndex:o,endIndex:l,workerIndex:a};s.postMessage(c),s.onmessage=function(u){const h=u.data,f=new Float32Array(h.positions),d=new Float32Array(h.colors),g=h.workerIndex,_=Math.floor(g*Ge.count/Rr)*3,m=f.length;if(i(f)||i(d)){console.error("NaN values detected in worker data.");return}_+m<=ri.attributes.position.array.length?(ri.attributes.position.array.set(f,_),ri.attributes.color.array.set(d,_)):(console.error("Data received from worker exceeds buffer size."),console.error("Received:",_+m,"Length accepted:",ri.attributes.position.array.length)),ri.attributes.position.needsUpdate=!0,ri.attributes.color.needsUpdate=!0,e++,e===Rr&&(sc=new $c({size:Ge.size,alphaMap:HM,transparent:!0,sizeAttenuation:!0,depthWrite:!1,blending:Ia,vertexColors:!0}),Pi=new ad(ri,sc),Cf=Pi.position.set(Ge.position.x,Ge.position.y,Ge.position.z),Pi.rotation.y=2,Cf.needsUpdate=!0,Do.add(Pi))}});function i(s){for(let a=0;a<s.length;a++)if(isNaN(s[a]))return!0;return!1}};zp();const mn={width:window.innerWidth,height:window.innerHeight};let Ye=new zn(75,mn.width/mn.height,.1,100);window.innerWidth<=768&&(Ye=new zn(55,mn.width/mn.height,.1,50));Ye.position.set(0,6,4);Ye.rotation.set(-.767,0,0);kr.position.y=Ye.position.y;kr.position.x=Ye.position.x;kr.position.z=Ye.position.z;Do.add(kr);const fi=new Zs;Do.add(fi);fi.add(Ye);const Uo=new od({canvas:kM});Uo.setSize(mn.width,mn.height);Uo.setPixelRatio(Math.min(window.devicePixelRatio));window.addEventListener("resize",()=>{mn.width=window.innerWidth,mn.height=window.innerHeight,Ye.aspect=mn.width/mn.height,Ye.updateProjectionMatrix(),Uo.setSize(mn.width,mn.height),Uo.setPixelRatio(Math.min(window.devicePixelRatio)),window.innerHeight>=1250&&ro()});let hi=0;const WM=(r,e)=>{let t;return function(){clearTimeout(t),t=setTimeout(r,e)}},ro=WM(zp,0);ht.defaults({preventOverlaps:!0,fastScrollEnd:!0});const Vt=ht.timeline(),Su=new TS({duration:1,lerp:.05,wheelMultiplier:1,easing:r=>r*(1-r),smooth:!0});Su.on("scroll",({scroll:r})=>{const e=Math.round(r/mn.height);e!==hi&&(hi=e,hi==0&&(ht.to(Ye.position,{x:0,z:4,y:6,ease:"power1.inOut",duration:1}),ht.to(Ye.rotation,{duration:1,ease:"power1.inOut",x:-.767,z:0,y:0})),hi==1&&(window.innerWidth<=768?(ht.to(Ge,{radius:1.5,spin:0,randomnessPower:10,onStart:()=>{Ge.count=1e4,Ge.size=.03,Ge.randomnessPower=20,Ge.randomness=0},onComplete:()=>{Ge.count=4e4,Ge.size=.03},onUpdate:ro}),ht.to(Ye.position,{x:0,z:4,y:6,ease:"power1.inOut"}),ht.to(Ye.rotation,{ease:"power1.inOut",x:-.767,z:0,y:0})):(ht.to(Ge,{radius:1.5,spin:0,randomnessPower:10,onStart:()=>{Ge.count=1e4,Ge.size=.005,Ge.randomnessPower=20,Ge.randomness=0},onComplete:()=>{Ge.count=4e4,Ge.size=.01},onUpdate:ro}),ht.to(Ye.position,{x:0,z:4,y:6,ease:"power1.inOut"}),ht.to(Ye.rotation,{ease:"power1.inOut",x:-.767,z:0,y:0}))),hi==2&&(window.innerWidth<=768?(ht.to(Ge,{radius:1.2,spin:5,randomnessPower:7,duration:1.5,onStart:()=>{Ge.count=7e3,Ge.size=.03,Ge.randomnessPower=20,Ge.randomness=.1},onComplete:()=>{Ge.count=5e4,Ge.size=.02},onUpdate:ro}),ht.to(Ye.position,{x:0,z:2,y:3,ease:"power1.inOut",duration:1}),ht.to(Ye.rotation,{ease:"power1.inOut",x:-.3,z:0,y:0})):(ht.to(Ge,{radius:4,spin:1.5,randomnessPower:4,duration:2,onStart:()=>{Ge.count=1e4,Ge.size=.02,Ge.randomnessPower=20,Ge.randomness=0},onComplete:()=>{Ge.count=25e4,Ge.size=.01},onUpdate:ro}),ht.to(Ye.position,{x:0,z:4,y:4,ease:"power1.inOut",duration:1}),ht.to(Ye.rotation,{ease:"power1.inOut",x:-.3,z:0,y:0}))),hi==4&&(window.innerWidth<=768?(Vt.to(Ye.position,{x:-.5,y:6,z:.5,duration:1,ease:"linear"}),Vt.to(Ye.rotation,{x:-1.6,y:0,z:0,ease:"linear"})):(Vt.to(Ye.position,{x:-6,y:12,z:.5,duration:1,ease:"linear"}),Vt.to(Ye.rotation,{x:-1.6,y:0,z:0,ease:"linear"}))),hi==5&&(window.innerWidth<=768?(Vt.to(Ye.position,{x:.5,y:5,z:3.5,ease:"power1.inOut"}),Vt.to(Ye.rotation,{x:-.93,y:0,z:0,ease:"power1.inOut"})):(Vt.to(Ye.position,{x:3.5,y:7,z:6.5,ease:"power1.inOut"}),Vt.to(Ye.rotation,{x:-.93,y:0,z:0,ease:"power1.inOut"}))),hi==6&&(window.innerWidth<=768?(Vt.to(Ye.position,{x:-1.5,y:3.5,z:1,ease:"power1.inOut"}),Vt.to(Ye.rotation,{x:-.895,y:-.455,z:-.347,ease:"power1.inOut"})):(Vt.to(Ye.position,{x:-4.5,y:3.5,z:1,ease:"power1.inOut"}),Vt.to(Ye.rotation,{x:-.895,y:-.455,z:-.347,ease:"power1.inOut"}))),hi==7&&(Vt.to(Ye.position,{x:2,y:2,z:0,ease:"power1.inOut"}),Vt.to(Ye.rotation,{x:0,y:2,z:0,ease:"power1.inOut"})),hi==8&&(window.innerWidth<=768?(Vt.to(Ye.position,{x:-.5,y:2,z:2.5,ease:"power1.inOut"}),Vt.to(Ye.rotation,{x:0,y:0,z:0,ease:"power1.inOut"})):(Vt.to(Ye.position,{x:-3.5,y:2,z:2.5,ease:"power1.inOut"}),Vt.to(Ye.rotation,{x:0,y:0,z:0,ease:"power1.inOut"}))))});function Bp(r){Su.raf(r),requestAnimationFrame(Bp)}requestAnimationFrame(Bp);Su.on("scroll",()=>{Qe.update()});Qe.defaults({markers:!1});ht.to(".hero",{duration:4,opacity:0,ease:"power1.inOut",scrollTrigger:{trigger:"body",start:"top top",end:"+=50%",scrub:2,markers:!1}});const XM=document.querySelectorAll("#pin-hero"),qM=ht.timeline();XM.forEach((r,e)=>{qM.to(r,{duration:4,opacity:0,ease:"power1.inOut",y:"100%",preventOverlaps:!0,scrollTrigger:{trigger:r,pin:!0,start:"bottom 20%",end:"+=50%",scrub:!0}})});const YM=document.querySelectorAll("#pin-second");YM.forEach((r,e)=>{ht.to(r,{duration:2,opacity:0,ease:"power4.inOut",backdropFilter:"blur(20px)",scrollTrigger:{trigger:r,pin:!0,start:"top top",end:"center",scrub:!0}})});const $M=document.querySelectorAll("#pin-section");$M.forEach((r,e)=>{ht.to(r,{duration:2,opacity:0,backdropFilter:"blur(20px)",ease:"power1.inOut",scrollTrigger:{trigger:r,pin:!0,start:"top top",end:"bottom",scrub:!0}})});const Ja={x:0,y:0};let kp=/iPhone|iPad|iPod|Android/i.test(navigator.userAgent),xo={alpha:0,beta:0,gamma:0};kp&&window.DeviceOrientationEvent?window.addEventListener("deviceorientation",r=>{xo.alpha=r.alpha,xo.beta=r.beta,xo.gamma=r.gamma}):window.addEventListener("mousemove",r=>{Ja.x=r.clientX/mn.width-.5,Ja.y=r.clientY/mn.height-.5});const KM=new iS;let Pf=0;const Hp=()=>{const r=KM.getElapsedTime(),e=r-Pf;if(Pf=r,Pi&&(Pi.rotation.y=r*.05),kr.position.x=Math.cos(r)*.05+Ye.position.x,kr.position.z=Math.sin(r)*.05+Ye.position.z-5,kr.position.y=Math.sin(r)*.05+Ye.position.y,kp){const t=xo.gamma/90,n=xo.beta/90;fi.position.x+=(t-fi.position.x)*2*e,fi.position.y+=(n-fi.position.y)*2*e}else{const t=Ja.x*.5,n=-Ja.y*.5;fi.position.x+=(t-fi.position.x)*2*e,fi.position.y+=(n-fi.position.y)*2*e}Uo.render(Do,Ye),window.requestAnimationFrame(Hp)};Hp();ht.defaults({markers:!1});let oc=0;const In=document.body;document.addEventListener("DOMContentLoaded",function(){const r=document.getElementById("contact-form"),e=document.getElementById("overlay"),t=document.getElementsByClassName("close-btn");document.querySelectorAll("#opn-contact").forEach(function(i){i.addEventListener("click",function(s){s.preventDefault(),r.style.display="block",e.style.display="block",document.body.classList.add("no-scroll")})}),Array.from(t).forEach(function(i){i.addEventListener("click",function(s){s.preventDefault(),r.style.display="none",e.style.display="none",document.body.classList.remove("no-scroll")})}),e.addEventListener("click",function(i){i.preventDefault(),r.style.display="none",e.style.display="none",document.body.classList.remove("no-scroll")})});window.addEventListener("scroll",()=>{const r=window.scrollY,e=Math.round(r/window.innerHeight);r<=0&&(In.classList.remove("scroll-up"),In.classList.add("scroll-up-btn"),In.classList.remove("scroll-down-btn")),r>oc&&!In.classList.contains("scroll-down")&&(In.classList.remove("scroll-up"),In.classList.remove("scroll-up-btn"),In.classList.add("scroll-down"),In.classList.add("scroll-down-btn")),r<oc&&In.classList.contains("scroll-down")&&(In.classList.remove("scroll-down"),In.classList.remove("scroll-down-btn"),In.classList.add("scroll-up"),In.classList.add("scroll-up-btn")),oc=r,e==2&&ht.fromTo(".a",{backdropFilter:"blur(10px)",backgroundColor:"linear-gradient(90deg, rgba(0, 0, 0, 0.1), rgba(255, 255, 255, 0))",duration:1,delay:3},{backdropFilter:"none",backgroundColor:"none"})});const ZM=ht.timeline();ZM.from(".navbar",{top:"-30%",duration:2});ht.from(".logo",{scale:0,x:"5000%",rotate:"150%",duration:2.5});ht.from(".content-frame",{backdropFilter:"blur(20px)",duration:2});ht.to(".marquee__part",{xPercent:-100,repeat:-1,duration:5,ease:"linear"});
//# sourceMappingURL=index-36092c87.js.map
