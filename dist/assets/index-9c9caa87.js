...
*/var Zt,Ea,Bn,$i,Ki,Ms,ad,Sr,so,ld,Ii,ri,cd,ud=function(){return Zt||typeof window<"u"&&(Zt=window.gsap)&&Zt.registerPlugin&&Zt},hd=1,ms=[],Qe=[],vi=[],oo=Date.now,_c=function(e,t){return t},iS=function(){var e=so.core,t=e.bridge||{},n=e._scrollers,i=e._proxies;n.push.apply(n,Qe),i.push.apply(i,vi),Qe=n,vi=i,_c=function(a,o){return t[a](o)}},nr=function(e,t){return~vi.indexOf(e)&&vi[vi.indexOf(e)+1][t]},ao=function(e){return!!~ld.indexOf(e)},ln=function(e,t,n,i,s){return e.addEventListener(t,n,{passive:i!==!1,capture:!!s})},an=function(e,t,n,i){return e.removeEventListener(t,n,!!i)},la="scrollLeft",ca="scrollTop",gc=function(){return Ii&&Ii.isPressed||Qe.cache++},Ba=function(e,t){var n=function i(s){if(s||s===0){hd&&(Bn.history.scrollRestoration="manual");var a=Ii&&Ii.isPressed;s=i.v=Math.round(s)||(Ii&&Ii.iOS?1:0),e(s),i.cacheID=Qe.cache,a&&_c("ss",s)}else(t||Qe.cache!==i.cacheID||_c("ref"))&&(i.cacheID=Qe.cache,i.v=e());return i.v+i.offset};return n.offset=0,e&&n},mn={s:la,p:"left",p2:"Left",os:"right",os2:"Right",d:"width",d2:"Width",a:"x",sc:Ba(function(r){return arguments.length?Bn.scrollTo(r,zt.sc()):Bn.pageXOffset||$i[la]||Ki[la]||Ms[la]||0})},zt={s:ca,p:"top",p2:"Top",os:"bottom",os2:"Bottom",d:"height",d2:"Height",a:"y",op:mn,sc:Ba(function(r){return arguments.length?Bn.scrollTo(mn.sc(),r):Bn.pageYOffset||$i[ca]||Ki[ca]||Ms[ca]||0})},xn=function(e,t){return(t&&t._ctx&&t._ctx.selector||Zt.utils.toArray)(e)[0]||(typeof e=="string"&&Zt.config().nullTargetWarn!==!1?console.warn("Element not found:",e):null)},or=function(e,t){var n=t.s,i=t.sc;ao(e)&&(e=$i.scrollingElement||Ki);var s=Qe.indexOf(e),a=i===zt.sc?1:2;!~s&&(s=Qe.push(e)-1),Qe[s+a]||ln(e,"scroll",gc);var o=Qe[s+a],l=o||(Qe[s+a]=Ba(nr(e,n),!0)||(ao(e)?i:Ba(function(c){return arguments.length?e[n]=c:e[n]})));return l.target=e,o||(l.smooth=Zt.getProperty(e,"scrollBehavior")==="smooth"),l},vc=function(e,t,n){var i=e,s=e,a=oo(),o=a,l=t||50,c=Math.max(500,l*3),u=function(g,_){var m=oo();_||m-a>l?(s=i,i=g,o=a,a=m):n?i+=g:i=s+(g-s)/(m-o)*(a-o)},h=function(){s=i=n?0:i,o=a=0},f=function(g){var _=o,m=s,p=oo();return(g||g===0)&&g!==i&&u(g),a===o||p-o>c?0:(i+(n?m:-m))/((n?p:a)-_)*1e3};return{update:u,reset:h,getVelocity:f}},Xs=function(e,t){return t&&!e._gsapAllow&&e.preventDefault(),e.changedTouches?e.changedTouches[0]:e},qh=function(e){var t=Math.max.apply(Math,e),n=Math.min.apply(Math,e);return Math.abs(t)>=Math.abs(n)?t:n},fd=function(){so=Zt.core.globals().ScrollTrigger,so&&so.core&&iS()},dd=function(e){return Zt=e||ud(),!Ea&&Zt&&typeof document<"u"&&document.body&&(Bn=window,$i=document,Ki=$i.documentElement,Ms=$i.body,ld=[Bn,$i,Ki,Ms],Zt.utils.clamp,cd=Zt.core.context||function(){},Sr="onpointerenter"in Ms?"pointer":"mouse",ad=Lt.isTouch=Bn.matchMedia&&Bn.matchMedia("(hover: none), (pointer: coarse)").matches?1:"ontouchstart"in Bn||navigator.maxTouchPoints>0||navigator.msMaxTouchPoints>0?2:0,ri=Lt.eventTypes=("ontouchstart"in Ki?"touchstart,touchmove,touchcancel,touchend":"onpointerdown"in Ki?"pointerdown,pointermove,pointercancel,pointerup":"mousedown,mousemove,mouseup,mouseup").split(","),setTimeout(function(){return hd=0},500),fd(),Ea=1),Ea};mn.op=zt;Qe.cache=0;var Lt=function(){function r(t){this.init(t)}var e=r.prototype;return e.init=function(n){Ea||dd(Zt)||console.warn("Please gsap.registerPlugin(Observer)"),so||fd();var i=n.tolerance,s=n.dragMinimum,a=n.type,o=n.target,l=n.lineHeight,c=n.debounce,u=n.preventDefault,h=n.onStop,f=n.onStopDelay,d=n.ignore,g=n.wheelSpeed,_=n.event,m=n.onDragStart,p=n.onDragEnd,M=n.onDrag,v=n.onPress,S=n.onRelease,y=n.onRight,w=n.onLeft,A=n.onUp,D=n.onDown,x=n.onChangeX,b=n.onChangeY,F=n.onChange,N=n.onToggleX,Z=n.onToggleY,P=n.onHover,B=n.onHoverEnd,q=n.onMove,O=n.ignoreCheck,j=n.isNormalizer,Y=n.onGestureStart,R=n.onGestureEnd,U=n.onWheel,$=n.onEnable,ue=n.onDisable,oe=n.onClick,he=n.scrollSpeed,Ee=n.capture,Le=n.allowClicks,ye=n.lockAxis,Ce=n.onLockAxis;this.target=o=xn(o)||Ki,this.vars=n,d&&(d=Zt.utils.toArray(d)),i=i||1e-9,s=s||0,g=g||1,he=he||1,a=a||"wheel,touch,pointer",c=c!==!1,l||(l=parseFloat(Bn.getComputedStyle(Ms).lineHeight)||22);var st,De,k,He,pe,be,Ae,G=this,Be=0,ke=0,et=n.passive||!u,Ye=or(o,mn),vt=or(o,zt),C=Ye(),E=vt(),z=~a.indexOf("touch")&&!~a.indexOf("pointer")&&ri[0]==="pointerdown",ie=ao(o),J=o.ownerDocument||$i,ee=[0,0,0],me=[0,0,0],re=0,de=function(){return re=oo()},_e=function(Se,Re){return(G.event=Se)&&d&&~d.indexOf(Se.target)||Re&&z&&Se.pointerType!=="touch"||O&&O(Se,Re)},tt=function(){G._vx.reset(),G._vy.reset(),De.pause(),h&&h(G)},ne=function(){var Se=G.deltaX=qh(ee),Re=G.deltaY=qh(me),se=Math.abs(Se)>=i,Ne=Math.abs(Re)>=i;F&&(se||Ne)&&F(G,Se,Re,ee,me),se&&(y&&G.deltaX>0&&y(G),w&&G.deltaX<0&&w(G),x&&x(G),N&&G.deltaX<0!=Be<0&&N(G),Be=G.deltaX,ee[0]=ee[1]=ee[2]=0),Ne&&(D&&G.deltaY>0&&D(G),A&&G.deltaY<0&&A(G),b&&b(G),Z&&G.deltaY<0!=ke<0&&Z(G),ke=G.deltaY,me[0]=me[1]=me[2]=0),(He||k)&&(q&&q(G),k&&(M(G),k=!1),He=!1),be&&!(be=!1)&&Ce&&Ce(G),pe&&(U(G),pe=!1),st=0},nt=function(Se,Re,se){ee[se]+=Se,me[se]+=Re,G._vx.update(Se),G._vy.update(Re),c?st||(st=requestAnimationFrame(ne)):ne()},ze=function(Se,Re){ye&&!Ae&&(G.axis=Ae=Math.abs(Se)>Math.abs(Re)?"x":"y",be=!0),Ae!=="y"&&(ee[2]+=Se,G._vx.update(Se,!0)),Ae!=="x"&&(me[2]+=Re,G._vy.update(Re,!0)),c?st||(st=requestAnimationFrame(ne)):ne()},Ue=function(Se){if(!_e(Se,1)){Se=Xs(Se,u);var Re=Se.clientX,se=Se.clientY,Ne=Re-G.x,Ie=se-G.y,Ge=G.isDragging;G.x=Re,G.y=se,(Ge||Math.abs(G.startX-Re)>=s||Math.abs(G.startY-se)>=s)&&(M&&(k=!0),Ge||(G.isDragging=!0),ze(Ne,Ie),Ge||m&&m(G))}},Pe=G.onPress=function(ve){_e(ve,1)||ve&&ve.button||(G.axis=Ae=null,De.pause(),G.isPressed=!0,ve=Xs(ve),Be=ke=0,G.startX=G.x=ve.clientX,G.startY=G.y=ve.clientY,G._vx.reset(),G._vy.reset(),ln(j?o:J,ri[1],Ue,et,!0),G.deltaX=G.deltaY=0,v&&v(G))},Q=G.onRelease=function(ve){if(!_e(ve,1)){an(j?o:J,ri[1],Ue,!0);var Se=!isNaN(G.y-G.startY),Re=G.isDragging,se=Re&&(Math.abs(G.x-G.startX)>3||Math.abs(G.y-G.startY)>3),Ne=Xs(ve);!se&&Se&&(G._vx.reset(),G._vy.reset(),u&&Le&&Zt.delayedCall(.08,function(){if(oo()-re>300&&!ve.defaultPrevented){if(ve.target.click)ve.target.click();else if(J.createEvent){var Ie=J.createEvent("MouseEvents");Ie.initMouseEvent("click",!0,!0,Bn,1,Ne.screenX,Ne.screenY,Ne.clientX,Ne.clientY,!1,!1,!1,!1,0,null),ve.target.dispatchEvent(Ie)}}})),G.isDragging=G.isGesturing=G.isPressed=!1,h&&Re&&!j&&De.restart(!0),p&&Re&&p(G),S&&S(G,se)}},We=function(Se){return Se.touches&&Se.touches.length>1&&(G.isGesturing=!0)&&Y(Se,G.isDragging)},L=function(){return(G.isGesturing=!1)||R(G)},ce=function(Se){if(!_e(Se)){var Re=Ye(),se=vt();nt((Re-C)*he,(se-E)*he,1),C=Re,E=se,h&&De.restart(!0)}},te=function(Se){if(!_e(Se)){Se=Xs(Se,u),U&&(pe=!0);var Re=(Se.deltaMode===1?l:Se.deltaMode===2?Bn.innerHeight:1)*g;nt(Se.deltaX*Re,Se.deltaY*Re,0),h&&!j&&De.restart(!0)}},K=function(Se){if(!_e(Se)){var Re=Se.clientX,se=Se.clientY,Ne=Re-G.x,Ie=se-G.y;G.x=Re,G.y=se,He=!0,h&&De.restart(!0),(Ne||Ie)&&ze(Ne,Ie)}},ae=function(Se){G.event=Se,P(G)},we=function(Se){G.event=Se,B(G)},Je=function(Se){return _e(Se)||Xs(Se,u)&&oe(G)};De=G._dc=Zt.delayedCall(f||.25,tt).pause(),G.deltaX=G.deltaY=0,G._vx=vc(0,50,!0),G._vy=vc(0,50,!0),G.scrollX=Ye,G.scrollY=vt,G.isDragging=G.isGesturing=G.isPressed=!1,cd(this),G.enable=function(ve){return G.isEnabled||(ln(ie?J:o,"scroll",gc),a.indexOf("scroll")>=0&&ln(ie?J:o,"scroll",ce,et,Ee),a.indexOf("wheel")>=0&&ln(o,"wheel",te,et,Ee),(a.indexOf("touch")>=0&&ad||a.indexOf("pointer")>=0)&&(ln(o,ri[0],Pe,et,Ee),ln(J,ri[2],Q),ln(J,ri[3],Q),Le&&ln(o,"click",de,!0,!0),oe&&ln(o,"click",Je),Y&&ln(J,"gesturestart",We),R&&ln(J,"gestureend",L),P&&ln(o,Sr+"enter",ae),B&&ln(o,Sr+"leave",we),q&&ln(o,Sr+"move",K)),G.isEnabled=!0,ve&&ve.type&&Pe(ve),$&&$(G)),G},G.disable=function(){G.isEnabled&&(ms.filter(function(ve){return ve!==G&&ao(ve.target)}).length||an(ie?J:o,"scroll",gc),G.isPressed&&(G._vx.reset(),G._vy.reset(),an(j?o:J,ri[1],Ue,!0)),an(ie?J:o,"scroll",ce,Ee),an(o,"wheel",te,Ee),an(o,ri[0],Pe,Ee),an(J,ri[2],Q),an(J,ri[3],Q),an(o,"click",de,!0),an(o,"click",Je),an(J,"gesturestart",We),an(J,"gestureend",L),an(o,Sr+"enter",ae),an(o,Sr+"leave",we),an(o,Sr+"move",K),G.isEnabled=G.isPressed=G.isDragging=!1,ue&&ue(G))},G.kill=G.revert=function(){G.disable();var ve=ms.indexOf(G);ve>=0&&ms.splice(ve,1),Ii===G&&(Ii=0)},ms.push(G),j&&ao(o)&&(Ii=G),G.enable(_)},nS(r,[{key:"velocityX",get:function(){return this._vx.getVelocity()}},{key:"velocityY",get:function(){return this._vy.getVelocity()}}]),r}();Lt.version="3.12.5";Lt.create=function(r){return new Lt(r)};Lt.register=dd;Lt.getAll=function(){return ms.slice()};Lt.getById=function(r){return ms.filter(function(e){return e.vars.id===r})[0]};ud()&&Zt.registerPlugin(Lt);/*!
 ...
 * Club GSAP members, the agreement issued with that membership.
 * @author: Jack Doyle, jack@greensock.com
*/var xf,ji,bs,mu,Ar,Sf,_u,mM=function(){return typeof window<"u"},Bi={},Er=180/Math.PI,As=Math.PI/180,hs=Math.atan2,Mf=1e8,gu=/([A-Z])/g,_M=/(left|right|width|margin|padding|x)/i,gM=/[\s,\(]\S/,gi={autoAlpha:"opacity,visibility",scale:"scaleX,scaleY",alpha:"opacity"},Fc=function(e,t){return t.set(t.t,t.p,Math.round((t.s+t.c*e)*1e4)/1e4+t.u,t)},vM=function(e,t){return t.set(t.t,t.p,e===1?t.e:Math.round((t.s+t.c*e)*1e4)/1e4+t.u,t)},xM=function(e,t){return t.set(t.t,t.p,e?Math.round((t.s+t.c*e)*1e4)/1e4+t.u:t.b,t)},SM=function(e,t){var n=t.s+t.c*e;t.set(t.t,t.p,~~(n+(n<0?-.5:.5))+t.u,t)},Ep=function(e,t){return t.set(t.t,t.p,e?t.e:t.b,t)},yp=function(e,t){return t.set(t.t,t.p,e!==1?t.b:t.e,t)},MM=function(e,t,n){return e.style[t]=n},EM=function(e,t,n){return e.style.setProperty(t,n)},yM=function(e,t,n){return e._gsap[t]=n},TM=function(e,t,n){return e._gsap.scaleX=e._gsap.scaleY=n},bM=function(e,t,n,i,s){var a=e._gsap;a.scaleX=a.scaleY=n,a.renderTransform(s,a)},AM=function(e,t,n,i,s){var a=e._gsap;a[t]=n,a.renderTransform(s,a)},wt="transform",wn=wt+"Origin",wM=function r(e,t){var n=this,i=this.target,s=i.style,a=i._gsap;if(e in Bi&&s){if(this.tfm=this.tfm||{},e!=="transform")e=gi[e]||e,~e.indexOf(",")?e.split(",").forEach(function(o){return n.tfm[o]=Pi(i,o)}):this.tfm[e]=a.x?a[e]:Pi(i,e),e===wn&&(this.tfm.zOrigin=a.zOrigin);else return gi.transform.split(",").forEach(function(o){return r.call(n,o,t)});if(this.props.indexOf(wt)>=0)return;a.svg&&(this.svgo=i.getAttribute("data-svg-origin"),this.props.push(wn,t,"")),e=wt}(s||t)&&this.props.push(e,t,s[e])},Tp=function(e){e.translate&&(e.removeProperty("translate"),e.removeProperty("scale"),e.removeProperty("rotate"))},RM=function(){var e=this.props,t=this.target,n=t.style,i=t._gsap,s,a;for(s=0;s<e.length;s+=3)e[s+1]?t[e[s]]=e[s+2]:e[s+2]?n[e[s]]=e[s+2]:n.removeProperty(e[s].substr(0,2)==="--"?e[s]:e[s].replace(gu,"-$1").toLowerCase());if(this.tfm){for(a in this.tfm)i[a]=this.tfm[a];i.svg&&(i.renderTransform(),t.setAttribute("data-svg-origin",this.svgo||"")),s=_u(),(!s||!s.isStart)&&!n[wt]&&(Tp(n),i.zOrigin&&n[wn]&&(n[wn]+=" "+i.zOrigin+"px",i.zOrigin=0,i.renderTransform()),i.uncache=1)}},bp=function(e,t){var n={target:e,props:[],revert:RM,save:wM};return e._gsap||Rn.core.getCache(e),t&&t.split(",").forEach(function(i){return n.save(i)}),n},Ap,Bc=function(e,t){var n=ji.createElementNS?ji.createElementNS((t||"http://www.w3.org/1999/xhtml").replace(/^https/,"http"),e):ji.createElement(e);return n&&n.style?n:ji.createElement(e)},xi=function r(e,t,n){var i=getComputedStyle(e);return i[t]||i.getPropertyValue(t.replace(gu,"-$1").toLowerCase())||i.getPropertyValue(t)||!n&&r(e,Os(t)||t,1)||""},Ef="O,Moz,ms,Ms,Webkit".split(","),Os=function(e,t,n){var i=t||Ar,s=i.style,a=5;if(e in s&&!n)return e;for(e=e.charAt(0).toUpperCase()+e.substr(1);a--&&!(Ef[a]+e in s););return a<0?null:(a===3?"ms":a>=0?Ef[a]:"")+e},zc=function(){mM()&&window.document&&(xf=window,ji=xf.document,bs=ji.documentElement,Ar=Bc("div")||{style:{}},Bc("div"),wt=Os(wt),wn=wt+"Origin",Ar.style.cssText="border-width:0;line-height:0;position:absolute;padding:0",Ap=!!Os("perspective"),_u=Rn.core.reverting,mu=1)},tc=function r(e){var t=Bc("svg",this.ownerSVGElement&&this.ownerSVGElement.getAttribute("xmlns")||"http://www.w3.org/2000/svg"),n=this.parentNode,i=this.nextSibling,s=this.style.cssText,a;if(bs.appendChild(t),t.appendChild(this),this.style.display="block",e)try{a=this.getBBox(),this._gsapBBox=this.getBBox,this.getBBox=r}catch{}else this._gsapBBox&&(a=this._gsapBBox());return n&&(i?n.insertBefore(this,i):n.appendChild(this)),bs.removeChild(t),this.style.cssText=s,a},yf=function(e,t){for(var n=t.length;n--;)if(e.hasAttribute(t[n]))return e.getAttribute(t[n])},wp=function(e){var t;try{t=e.getBBox()}catch{t=tc.call(e,!0)}return t&&(t.width||t.height)||e.getBBox===tc||(t=tc.call(e,!0)),t&&!t.width&&!t.x&&!t.y?{x:+yf(e,["x","cx","x1"])||0,y:+yf(e,["y","cy","y1"])||0,width:0,height:0}:t},Rp=function(e){return!!(e.getCTM&&(!e.parentNode||e.ownerSVGElement)&&wp(e))},Xr=function(e,t){if(t){var n=e.style,i;t in Bi&&t!==wn&&(t=wt),n.removeProperty?(i=t.substr(0,2),(i==="ms"||t.substr(0,6)==="webkit")&&(t="-"+t),n.removeProperty(i==="--"?t:t.replace(gu,"-$1").toLowerCase())):n.removeAttribute(t)}},Ji=function(e,t,n,i,s,a){var o=new An(e._pt,t,n,0,1,a?yp:Ep);return e._pt=o,o.b=i,o.e=s,e._props.push(n),o},Tf={deg:1,rad:1,turn:1},CM={grid:1,flex:1},lr=function r(e,t,n,i){var s=parseFloat(n)||0,a=(n+"").trim().substr((s+"").length)||"px",o=Ar.style,l=_M.test(t),c=e.tagName.toLowerCase()==="svg",u=(c?"client":"offset")+(l?"Width":"Height"),h=100,f=i==="px",d=i==="%",g,_,m,p;if(i===a||!s||Tf[i]||Tf[a])return s;if(a!=="px"&&!f&&(s=r(e,t,n,"px")),p=e.getCTM&&Rp(e),(d||a==="%")&&(Bi[t]||~t.indexOf("adius")))return g=p?e.getBBox()[l?"width":"height"]:e[u],Pt(d?s/g*h:s/100*g);if(o[l?"width":"height"]=h+(f?a:i),_=~t.indexOf("adius")||i==="em"&&e.appendChild&&!c?e:e.parentNode,p&&(_=(e.ownerSVGElement||{}).parentNode),(!_||_===ji||!_.appendChild)&&(_=ji.body),m=_._gsap,m&&d&&m.width&&l&&m.time===zn.time&&!m.uncache)return Pt(s/m.width*h);if(d&&(t==="height"||t==="width")){var M=e.style[t];e.style[t]=h+i,g=e[u],M?e.style[t]=M:Xr(e,t)}else(d||a==="%")&&!CM[xi(_,"display")]&&(o.position=xi(e,"position")),_===e&&(o.position="static"),_.appendChild(Ar),g=Ar[u],_.removeChild(Ar),o.position="absolute";return l&&d&&(m=Ir(_),m.time=zn.time,m.width=_[u]),Pt(f?g*s/h:g&&s?h/g*s:0)},Pi=function(e,t,n,i){var s;return mu||zc(),t in gi&&t!=="transform"&&(t=gi[t],~t.indexOf(",")&&(t=t.split(",")[0])),Bi[t]&&t!=="transform"?(s=Co(e,i),s=t!=="transformOrigin"?s[t]:s.svg?s.origin:Ka(xi(e,wn))+" "+s.zOrigin+"px"):(s=e.style[t],(!s||s==="auto"||i||~(s+"").indexOf("calc("))&&(s=$a[t]&&$a[t](e,t,n)||xi(e,t)||Wd(e,t)||(t==="opacity"?1:0))),n&&!~(s+"").trim().indexOf(" ")?lr(e,t,s,n)+n:s},PM=function(e,t,n,i){if(!n||n==="none"){var s=Os(t,e,1),a=s&&xi(e,s,1);a&&a!==n?(t=s,n=a):t==="borderColor"&&(n=xi(e,"borderTopColor"))}var o=new An(this._pt,e.style,t,0,1,xp),l=0,c=0,u,h,f,d,g,_,m,p,M,v,S,y;if(o.b=n,o.e=i,n+="",i+="",i==="auto"&&(_=e.style[t],e.style[t]=i,i=xi(e,t)||i,_?e.style[t]=_:Xr(e,t)),u=[n,i],cp(u),n=u[0],i=u[1],f=n.match(_s)||[],y=i.match(_s)||[],y.length){for(;h=_s.exec(i);)m=h[0],M=i.substring(l,h.index),g?g=(g+1)%5:(M.substr(-5)==="rgba("||M.substr(-5)==="hsla(")&&(g=1),m!==(_=f[c++]||"")&&(d=parseFloat(_)||0,S=_.substr((d+"").length),m.charAt(1)==="="&&(m=Ts(d,m)+S),p=parseFloat(m),v=m.substr((p+"").length),l=_s.lastIndex-v.length,v||(v=v||Gn.units[t]||S,l===i.length&&(i+=v,o.e+=v)),S!==v&&(d=lr(e,t,_,v)||0),o._pt={_next:o._pt,p:M||c===1?M:",",s:d,c:p-d,m:g&&g<4||t==="zIndex"?Math.round:0});o.c=l<i.length?i.substring(l,i.length):""}else o.r=t==="display"&&i==="none"?yp:Ep;return Bd.test(i)&&(o.e=0),this._pt=o,o},bf={top:"0%",bottom:"100%",left:"0%",right:"100%",center:"50%"},LM=function(e){var t=e.split(" "),n=t[0],i=t[1]||"50%";return(n==="top"||n==="bottom"||i==="left"||i==="right")&&(e=n,n=i,i=e),t[0]=bf[n]||n,t[1]=bf[i]||i,t.join(" ")},DM=function(e,t){if(t.tween&&t.tween._time===t.tween._dur){var n=t.t,i=n.style,s=t.u,a=n._gsap,o,l,c;if(s==="all"||s===!0)i.cssText="",l=1;else for(s=s.split(","),c=s.length;--c>-1;)o=s[c],Bi[o]&&(l=1,o=o==="transformOrigin"?wn:wt),Xr(n,o);l&&(Xr(n,wt),a&&(a.svg&&n.removeAttribute("transform"),Co(n,1),a.uncache=1,Tp(i)))}},$a={clearProps:function(e,t,n,i,s){if(s.data!=="isFromStart"){var a=e._pt=new An(e._pt,t,n,0,0,DM);return a.u=i,a.pr=-10,a.tween=s,e._props.push(n),1}}},Ro=[1,0,0,1,0,0],Cp={},Pp=function(e){return e==="matrix(1, 0, 0, 1, 0, 0)"||e==="none"||!e},Af=function(e){var t=xi(e,wt);return Pp(t)?Ro:t.substr(7).match(Fd).map(Pt)},vu=function(e,t){var n=e._gsap||Ir(e),i=e.style,s=Af(e),a,o,l,c;return n.svg&&e.getAttribute("transform")?(l=e.transform.baseVal.consolidate().matrix,s=[l.a,l.b,l.c,l.d,l.e,l.f],s.join(",")==="1,0,0,1,0,0"?Ro:s):(s===Ro&&!e.offsetParent&&e!==bs&&!n.svg&&(l=i.display,i.display="block",a=e.parentNode,(!a||!e.offsetParent)&&(c=1,o=e.nextElementSibling,bs.appendChild(e)),s=Af(e),l?i.display=l:Xr(e,"display"),c&&(o?a.insertBefore(e,o):a?a.appendChild(e):bs.removeChild(e))),t&&s.length>6?[s[0],s[1],s[4],s[5],s[12],s[13]]:s)},kc=function(e,t,n,i,s,a){var o=e._gsap,l=s||vu(e,!0),c=o.xOrigin||0,u=o.yOrigin||0,h=o.xOffset||0,f=o.yOffset||0,d=l[0],g=l[1],_=l[2],m=l[3],p=l[4],M=l[5],v=t.split(" "),S=parseFloat(v[0])||0,y=parseFloat(v[1])||0,w,A,D,x;n?l!==Ro&&(A=d*m-g*_)&&(D=S*(m/A)+y*(-_/A)+(_*M-m*p)/A,x=S*(-g/A)+y*(d/A)-(d*M-g*p)/A,S=D,y=x):(w=wp(e),S=w.x+(~v[0].indexOf("%")?S/100*w.width:S),y=w.y+(~(v[1]||v[0]).indexOf("%")?y/100*w.height:y)),i||i!==!1&&o.smooth?(p=S-c,M=y-u,o.xOffset=h+(p*d+M*_)-p,o.yOffset=f+(p*g+M*m)-M):o.xOffset=o.yOffset=0,o.xOrigin=S,o.yOrigin=y,o.smooth=!!i,o.origin=t,o.originIsAbsolute=!!n,e.style[wn]="0px 0px",a&&(Ji(a,o,"xOrigin",c,S),Ji(a,o,"yOrigin",u,y),Ji(a,o,"xOffset",h,o.xOffset),Ji(a,o,"yOffset",f,o.yOffset)),e.setAttribute("data-svg-origin",S+" "+y)},Co=function(e,t){var n=e._gsap||new dp(e);if("x"in n&&!t&&!n.uncache)return n;var i=e.style,s=n.scaleX<0,a="px",o="deg",l=getComputedStyle(e),c=xi(e,wn)||"0",u,h,f,d,g,_,m,p,M,v,S,y,w,A,D,x,b,F,N,Z,P,B,q,O,j,Y,R,U,$,ue,oe,he;return u=h=f=_=m=p=M=v=S=0,d=g=1,n.svg=!!(e.getCTM&&Rp(e)),l.translate&&((l.translate!=="none"||l.scale!=="none"||l.rotate!=="none")&&(i[wt]=(l.translate!=="none"?"translate3d("+(l.translate+" 0 0").split(" ").slice(0,3).join(", ")+") ":"")+(l.rotate!=="none"?"rotate("+l.rotate+") ":"")+(l.scale!=="none"?"scale("+l.scale.split(" ").join(",")+") ":"")+(l[wt]!=="none"?l[wt]:"")),i.scale=i.rotate=i.translate="none"),A=vu(e,n.svg),n.svg&&(n.uncache?(j=e.getBBox(),c=n.xOrigin-j.x+"px "+(n.yOrigin-j.y)+"px",O=""):O=!t&&e.getAttribute("data-svg-origin"),kc(e,O||c,!!O||n.originIsAbsolute,n.smooth!==!1,A)),y=n.xOrigin||0,w=n.yOrigin||0,A!==Ro&&(F=A[0],N=A[1],Z=A[2],P=A[3],u=B=A[4],h=q=A[5],A.length===6?(d=Math.sqrt(F*F+N*N),g=Math.sqrt(P*P+Z*Z),_=F||N?hs(N,F)*Er:0,M=Z||P?hs(Z,P)*Er+_:0,M&&(g*=Math.abs(Math.cos(M*As))),n.svg&&(u-=y-(y*F+w*Z),h-=w-(y*N+w*P))):(he=A[6],ue=A[7],R=A[8],U=A[9],$=A[10],oe=A[11],u=A[12],h=A[13],f=A[14],D=hs(he,$),m=D*Er,D&&(x=Math.cos(-D),b=Math.sin(-D),O=B*x+R*b,j=q*x+U*b,Y=he*x+$*b,R=B*-b+R*x,U=q*-b+U*x,$=he*-b+$*x,oe=ue*-b+oe*x,B=O,q=j,he=Y),D=hs(-Z,$),p=D*Er,D&&(x=Math.cos(-D),b=Math.sin(-D),O=F*x-R*b,j=N*x-U*b,Y=Z*x-$*b,oe=P*b+oe*x,F=O,N=j,Z=Y),D=hs(N,F),_=D*Er,D&&(x=Math.cos(D),b=Math.sin(D),O=F*x+N*b,j=B*x+q*b,N=N*x-F*b,q=q*x-B*b,F=O,B=j),m&&Math.abs(m)+Math.abs(_)>359.9&&(m=_=0,p=180-p),d=Pt(Math.sqrt(F*F+N*N+Z*Z)),g=Pt(Math.sqrt(q*q+he*he)),D=hs(B,q),M=Math.abs(D)>2e-4?D*Er:0,S=oe?1/(oe<0?-oe:oe):0),n.svg&&(O=e.getAttribute("transform"),n.forceCSS=e.setAttribute("transform","")||!Pp(xi(e,wt)),O&&e.setAttribute("transform",O))),Math.abs(M)>90&&Math.abs(M)<270&&(s?(d*=-1,M+=_<=0?180:-180,_+=_<=0?180:-180):(g*=-1,M+=M<=0?180:-180)),t=t||n.uncache,n.x=u-((n.xPercent=u&&(!t&&n.xPercent||(Math.round(e.offsetWidth/2)===Math.round(-u)?-50:0)))?e.offsetWidth*n.xPercent/100:0)+a,n.y=h-((n.yPercent=h&&(!t&&n.yPercent||(Math.round(e.offsetHeight/2)===Math.round(-h)?-50:0)))?e.offsetHeight*n.yPercent/100:0)+a,n.z=f+a,n.scaleX=Pt(d),n.scaleY=Pt(g),n.rotation=Pt(_)+o,n.rotationX=Pt(m)+o,n.rotationY=Pt(p)+o,n.skewX=M+o,n.skewY=v+o,n.transformPerspective=S+a,(n.zOrigin=parseFloat(c.split(" ")[2])||!t&&n.zOrigin||0)&&(i[wn]=Ka(c)),n.xOffset=n.yOffset=0,n.force3D=Gn.force3D,n.renderTransform=n.svg?IM:Ap?Lp:UM,n.uncache=0,n},Ka=function(e){return(e=e.split(" "))[0]+" "+e[1]},nc=function(e,t,n){var i=tn(t);return Pt(parseFloat(t)+parseFloat(lr(e,"x",n+"px",i)))+i},UM=function(e,t){t.z="0px",t.rotationY=t.rotationX="0deg",t.force3D=0,Lp(e,t)},_r="0deg",Ys="0px",gr=") ",Lp=function(e,t){var n=t||this,i=n.xPercent,s=n.yPercent,a=n.x,o=n.y,l=n.z,c=n.rotation,u=n.rotationY,h=n.rotationX,f=n.skewX,d=n.skewY,g=n.scaleX,_=n.scaleY,m=n.transformPerspective,p=n.force3D,M=n.target,v=n.zOrigin,S="",y=p==="auto"&&e&&e!==1||p===!0;if(v&&(h!==_r||u!==_r)){var w=parseFloat(u)*As,A=Math.sin(w),D=Math.cos(w),x;w=parseFloat(h)*As,x=Math.cos(w),a=nc(M,a,A*x*-v),o=nc(M,o,-Math.sin(w)*-v),l=nc(M,l,D*x*-v+v)}m!==Ys&&(S+="perspective("+m+gr),(i||s)&&(S+="translate("+i+"%, "+s+"%) "),(y||a!==Ys||o!==Ys||l!==Ys)&&(S+=l!==Ys||y?"translate3d("+a+", "+o+", "+l+") ":"translate("+a+", "+o+gr),c!==_r&&(S+="rotate("+c+gr),u!==_r&&(S+="rotateY("+u+gr),h!==_r&&(S+="rotateX("+h+gr),(f!==_r||d!==_r)&&(S+="skew("+f+", "+d+gr),(g!==1||_!==1)&&(S+="scale("+g+", "+_+gr),M.style[wt]=S||"translate(0, 0)"},IM=function(e,t){var n=t||this,i=n.xPercent,s=n.yPercent,a=n.x,o=n.y,l=n.rotation,c=n.skewX,u=n.skewY,h=n.scaleX,f=n.scaleY,d=n.target,g=n.xOrigin,_=n.yOrigin,m=n.xOffset,p=n.yOffset,M=n.forceCSS,v=parseFloat(a),S=parseFloat(o),y,w,A,D,x;l=parseFloat(l),c=parseFloat(c),u=parseFloat(u),u&&(u=parseFloat(u),c+=u,l+=u),l||c?(l*=As,c*=As,y=Math.cos(l)*h,w=Math.sin(l)*h,A=Math.sin(l-c)*-f,D=Math.cos(l-c)*f,c&&(u*=As,x=Math.tan(c-u),x=Math.sqrt(1+x*x),A*=x,D*=x,u&&(x=Math.tan(u),x=Math.sqrt(1+x*x),y*=x,w*=x)),y=Pt(y),w=Pt(w),A=Pt(A),D=Pt(D)):(y=h,D=f,w=A=0),(v&&!~(a+"").indexOf("px")||S&&!~(o+"").indexOf("px"))&&(v=lr(d,"x",a,"px"),S=lr(d,"y",o,"px")),(g||_||m||p)&&(v=Pt(v+g-(g*y+_*A)+m),S=Pt(S+_-(g*w+_*D)+p)),(i||s)&&(x=d.getBBox(),v=Pt(v+i/100*x.width),S=Pt(S+s/100*x.height)),x="matrix("+y+","+w+","+A+","+D+","+v+","+S+")",d.setAttribute("transform",x),M&&(d.style[wt]=x)},NM=function(e,t,n,i,s){var a=360,o=Yt(s),l=parseFloat(s)*(o&&~s.indexOf("rad")?Er:1),c=l-i,u=i+c+"deg",h,f;return o&&(h=s.split("_")[1],h==="short"&&(c%=a,c!==c%(a/2)&&(c+=c<0?a:-a)),h==="cw"&&c<0?c=(c+a*Mf)%a-~~(c/a)*a:h==="ccw"&&c>0&&(c=(c-a*Mf)%a-~~(c/a)*a)),e._pt=f=new An(e._pt,t,n,i,c,vM),f.e=u,f.u="deg",e._props.push(n),f},wf=function(e,t){for(var n in t)e[n]=t[n];return e},OM=function(e,t,n){var i=wf({},n._gsap),s="perspective,force3D,transformOrigin,svgOrigin",a=n.style,o,l,c,u,h,f,d,g;i.svg?(c=n.getAttribute("transform"),n.setAttribute("transform",""),a[wt]=t,o=Co(n,1),Xr(n,wt),n.setAttribute("transform",c)):(c=getComputedStyle(n)[wt],a[wt]=t,o=Co(n,1),a[wt]=c);for(l in Bi)c=i[l],u=o[l],c!==u&&s.indexOf(l)<0&&(d=tn(c),g=tn(u),h=d!==g?lr(n,l,c,g):parseFloat(c),f=parseFloat(u),e._pt=new An(e._pt,o,l,h,f-h,Fc),e._pt.u=g||0,e._props.push(l));wf(o,i)};bn("padding,margin,Width,Radius",function(r,e){var t="Top",n="Right",i="Bottom",s="Left",a=(e<3?[t,n,i,s]:[t+s,t+n,i+n,i+s]).map(function(o){return e<2?r+o:"border"+o+r});$a[e>1?"border"+r:r]=function(o,l,c,u,h){var f,d;if(arguments.length<4)return f=a.map(function(g){return Pi(o,g,c)}),d=f.join(" "),d.split(f[0]).length===5?f[0]:d;f=(u+"").split(" "),d={},a.forEach(function(g,_){return d[g]=f[_]=f[_]||f[(_-1)/2|0]}),o.init(l,d,h)}});var Dp={name:"css",register:zc,targetTest:function(e){return e.style&&e.nodeType},init:function(e,t,n,i,s){var a=this._props,o=e.style,l=n.vars.startAt,c,u,h,f,d,g,_,m,p,M,v,S,y,w,A,D;mu||zc(),this.styles=this.styles||bp(e),D=this.styles.props,this.tween=n;for(_ in t)if(_!=="autoRound"&&(u=t[_],!(On[_]&&pp(_,t,n,i,e,s)))){if(d=typeof u,g=$a[_],d==="function"&&(u=u.call(n,i,e,s),d=typeof u),d==="string"&&~u.indexOf("random(")&&(u=bo(u)),g)g(this,e,_,u,n)&&(A=1);else if(_.substr(0,2)==="--")c=(getComputedStyle(e).getPropertyValue(_)+"").trim(),u+="",rr.lastIndex=0,rr.test(c)||(m=tn(c),p=tn(u)),p?m!==p&&(c=lr(e,_,c,p)+p):m&&(u+=m),this.add(o,"setProperty",c,u,i,s,0,0,_),a.push(_),D.push(_,0,o[_]);else if(d!=="undefined"){if(l&&_ in l?(c=typeof l[_]=="function"?l[_].call(n,i,e,s):l[_],Yt(c)&&~c.indexOf("random(")&&(c=bo(c)),tn(c+"")||c==="auto"||(c+=Gn.units[_]||tn(Pi(e,_))||""),(c+"").charAt(1)==="="&&(c=Pi(e,_))):c=Pi(e,_),f=parseFloat(c),M=d==="string"&&u.charAt(1)==="="&&u.substr(0,2),M&&(u=u.substr(2)),h=parseFloat(u),_ in gi&&(_==="autoAlpha"&&(f===1&&Pi(e,"visibility")==="hidden"&&h&&(f=0),D.push("visibility",0,o.visibility),Ji(this,o,"visibility",f?"inherit":"hidden",h?"inherit":"hidden",!h)),_!=="scale"&&_!=="transform"&&(_=gi[_],~_.indexOf(",")&&(_=_.split(",")[0]))),v=_ in Bi,v){if(this.styles.save(_),S||(y=e._gsap,y.renderTransform&&!t.parseTransform||Co(e,t.parseTransform),w=t.smoothOrigin!==!1&&y.smooth,S=this._pt=new An(this._pt,o,wt,0,1,y.renderTransform,y,0,-1),S.dep=1),_==="scale")this._pt=new An(this._pt,y,"scaleY",y.scaleY,(M?Ts(y.scaleY,M+h):h)-y.scaleY||0,Fc),this._pt.u=0,a.push("scaleY",_),_+="X";else if(_==="transformOrigin"){D.push(wn,0,o[wn]),u=LM(u),y.svg?kc(e,u,0,w,0,this):(p=parseFloat(u.split(" ")[2])||0,p!==y.zOrigin&&Ji(this,y,"zOrigin",y.zOrigin,p),Ji(this,o,_,Ka(c),Ka(u)));continue}else if(_==="svgOrigin"){kc(e,u,1,w,0,this);continue}else if(_ in Cp){NM(this,y,_,f,M?Ts(f,M+u):u);continue}else if(_==="smoothOrigin"){Ji(this,y,"smooth",y.smooth,u);continue}else if(_==="force3D"){y[_]=u;continue}else if(_==="transform"){OM(this,u,e);continue}}else _ in o||(_=Os(_)||_);if(v||(h||h===0)&&(f||f===0)&&!gM.test(u)&&_ in o)m=(c+"").substr((f+"").length),h||(h=0),p=tn(u)||(_ in Gn.units?Gn.units[_]:m),m!==p&&(f=lr(e,_,c,p)),this._pt=new An(this._pt,v?y:o,_,f,(M?Ts(f,M+h):h)-f,!v&&(p==="px"||_==="zIndex")&&t.autoRound!==!1?SM:Fc),this._pt.u=p||0,m!==p&&p!=="%"&&(this._pt.b=c,this._pt.r=xM);else if(_ in o)PM.call(this,e,_,c,M?M+u:u);else if(_ in e)this.add(e,_,c||e[_],M?M+u:u,i,s);else if(_!=="parseTransform"){ou(_,u);continue}v||(_ in o?D.push(_,0,o[_]):D.push(_,1,c||e[_])),a.push(_)}}A&&Sp(this)},render:function(e,t){if(t.tween._time||!_u())for(var n=t._pt;n;)n.r(e,n.d),n=n._next;else t.styles.revert()},get:Pi,aliases:gi,getSetter:function(e,t,n){var i=gi[t];return i&&i.indexOf(",")<0&&(t=i),t in Bi&&t!==wn&&(e._gsap.x||Pi(e,"x"))?n&&Sf===n?t==="scale"?TM:yM:(Sf=n||{})&&(t==="scale"?bM:AM):e.style&&!iu(e.style[t])?MM:~t.indexOf("-")?EM:du(e,t)},core:{_removeProperty:Xr,_getMatrix:vu}};Rn.utils.checkPrefix=Os;Rn.core.getStyleSaver=bp;(function(r,e,t,n){var i=bn(r+","+e+","+t,function(s){Bi[s]=1});bn(e,function(s){Gn.units[s]="deg",Cp[s]=1}),gi[i[13]]=r+","+e,bn(n,function(s){var a=s.split(":");gi[a[1]]=i[a[0]]})})("x,y,z,scale,scaleX,scaleY,xPercent,yPercent","rotation,rotationX,rotationY,skewX,skewY","transform,transformOrigin,svgOrigin,force3D,smoothOrigin,transformPerspective","0:translateX,1:translateY,2:translateZ,8:rotate,8:rotationZ,8:rotateZ,9:rotateX,10:rotateY");bn("x,y,z,top,right,bottom,left,width,height,fontSize,padding,margin,perspective",function(r){Gn.units[r]="px"});Rn.registerPlugin(Dp);var Rt=Rn.registerPlugin(Dp)||Rn;Rt.core.Tween;function FM(){return new Worker(""+new URL("generateGalaxyWorker-ac2c9d7b.js",import.meta.url).href)}Rt.registerPlugin(je);const BM=document.querySelector("canvas.webgl"),Po=new Zx,Up=new eS;Up.load("./textures/particles/8.png");const zM=Up.load("./textures/particles/4.png"),Ip=500,La=new Float32Array(Ip*3);for(let r=0;r<Ip;r++)La[r*3+0]=(Math.random()-.5)*10,La[r*3+1]=.5-Math.random()*8,La[r*3+2]=(Math.random()-.5)*10;const Np=new ci;Np.setAttribute("position",new Hn(La,3));const kM=new Yc({color:"#ffffff",size:.08,blending:Da,alphaMap:zM,transparent:!0,depthWrite:!1,sizeAttenuation:!0,transparent:!0}),Br=new od(Np,kM),ot={count:9e4,size:.01,radius:1.5,branches:3,spin:0,randomness:.5,randomnessPower:10,insideColor:"#312eff",outsideColor:"#1b8360",position:{x:0,y:2,z:0}},Op=[],io=2;let Rf={};for(let r=0;r<io;r++)Op.push(new FM);let ii=new ci,ic=null,Ci=null;const Fp=()=>{const r={count:ot.count,maxRadius:ot.radius,branches:ot.branches,spin:ot.spin,randomnessPower:ot.randomnessPower,insideColor:ot.insideColor,outsideColor:ot.outsideColor};let e=0;Ci!==null&&(Po.remove(Ci),ii.dispose(),ic.dispose(),Ci=null);const t=new Float32Array(ot.count*3),n=new Float32Array(ot.count*3);ii=new ci,ii.setAttribute("position",new Hn(t,3)),ii.setAttribute("color",new Hn(n,3)),Op.forEach((s,a)=>{const o=Math.floor(a*ot.count/io),l=Math.floor((a+1)*ot.count/io),c={...r,startIndex:o,endIndex:l,workerIndex:a};s.postMessage(c),s.onmessage=function(u){const h=u.data,f=new Float32Array(h.positions),d=new Float32Array(h.colors),g=h.workerIndex,_=Math.floor(g*ot.count/io)*3,m=f.length;if(i(f)||i(d)){console.error("NaN values detected in worker data.");return}_+m<=ii.attributes.position.array.length?(ii.attributes.position.array.set(f,_),ii.attributes.color.array.set(d,_)):(console.error("Data received from worker exceeds buffer size."),console.error("Received:",_+m,"Length accepted:",ii.attributes.position.array.length)),ii.attributes.position.needsUpdate=!0,ii.attributes.color.needsUpdate=!0,e++,e===io&&(ic=new Yc({size:ot.size,sizeAttenuation:!0,depthWrite:!1,blending:Da,vertexColors:!0}),Ci=new od(ii,ic),Rf=Ci.position.set(ot.position.x,ot.position.y,ot.position.z),Ci.rotation.y=2,Rf.needsUpdate=!0,Po.add(Ci))}});function i(s){for(let a=0;a<s.length;a++)if(isNaN(s[a]))return!0;return!1}};Fp();const pn={width:window.innerWidth,height:window.innerHeight},HM=()=>/Android|iPhone|iPad|iPod|BlackBerry|IEMobile|Opera Mini/i.test(navigator.userAgent);let ct=new Fn(75,pn.width/pn.height,.1,100);HM&&(ct=new Fn(25,pn.width/pn.height,.1,50));ct.position.set(0,6,4);ct.rotation.set(-.767,0,0);Br.position.y=ct.position.y;Br.position.x=ct.position.x;Br.position.z=ct.position.z;Po.add(Br);const vs=new Ks;Po.add(vs);vs.add(ct);const Lo=new sd({canvas:BM});Lo.setSize(pn.width,pn.height);Lo.setPixelRatio(Math.min(window.devicePixelRatio));window.addEventListener("resize",()=>{pn.width=window.innerWidth,pn.height=window.innerHeight,ct.aspect=pn.width/pn.height,ct.updateProjectionMatrix(),Lo.setSize(pn.width,pn.height),Lo.setPixelRatio(Math.min(window.devicePixelRatio,2)),Hc()});let ui=0;const GM=(r,e)=>{let t;return function(){clearTimeout(t),t=setTimeout(r,e)}},Hc=GM(Fp,0);Rt.defaults({preventOverlaps:!0,fastScrollEnd:!0});const hi=Rt.timeline(),xu=new ES({duration:1,lerp:.05,wheelMultiplier:1,easing:r=>r*(1-r),smooth:!0});xu.on("scroll",({scroll:r})=>{const e=Math.round(r/pn.height);e!==ui&&(ui=e,ui==0&&(Rt.to(ct.position,{x:0,z:4,y:6,ease:"power1.inOut",duration:1}),Rt.to(ct.rotation,{duration:1,ease:"power1.inOut",x:-.767,z:0,y:0})),ui==1&&(Rt.to(ot,{radius:1.5,spin:0,randomnessPower:10,onStart:()=>{ot.count=1e4,ot.size=.005,ot.randomnessPower=20,ot.randomness=0},onComplete:()=>{ot.count=9e4,ot.size=.01},onUpdate:Hc}),Rt.to(ct.position,{x:0,z:4,y:6,ease:"power1.inOut"}),Rt.to(ct.rotation,{ease:"power1.inOut",x:-.767,z:0,y:0})),ui==2&&(Rt.to(ot,{radius:4,spin:1.5,randomnessPower:4,duration:2,onStart:()=>{ot.count=1e4,ot.size=.03,ot.randomnessPower=20,ot.randomness=0},onComplete:()=>{ot.count=25e4,ot.size=.02},onUpdate:Hc}),Rt.to(ct.position,{x:0,z:4,y:4,ease:"power1.inOut",duration:1}),Rt.to(ct.rotation,{ease:"power1.inOut",x:-.3,z:0,y:0})),ui==4&&(hi.to(ct.position,{x:-6,y:12,z:.5,duration:1,ease:"linear"}),hi.to(ct.rotation,{x:-1.6,y:0,z:0,ease:"linear"})),ui==5&&(hi.to(ct.position,{x:3.5,y:7,z:6.5,ease:"power1.inOut"}),hi.to(ct.rotation,{x:-.93,y:0,z:0,ease:"power1.inOut"})),ui==6&&(hi.to(ct.position,{x:-4.5,y:3.5,z:1,ease:"power1.inOut"}),hi.to(ct.rotation,{x:-.895,y:-.455,z:-.347,ease:"power1.inOut"})),ui==7&&(hi.to(ct.position,{x:2,y:2,z:0,ease:"power1.inOut"}),hi.to(ct.rotation,{x:0,y:2,z:0,ease:"power1.inOut"})),ui==8&&(hi.to(ct.position,{x:-3.5,y:2,z:2.5,ease:"power1.inOut"}),hi.to(ct.rotation,{x:0,y:0,z:0,ease:"power1.inOut"})))});function Bp(r){xu.raf(r),requestAnimationFrame(Bp)}requestAnimationFrame(Bp);xu.on("scroll",()=>{je.update()});je.defaults({markers:!1});Rt.to(".hero",{duration:4,opacity:0,ease:"power1.inOut",scrollTrigger:{trigger:"body",start:"top top",end:"+=50%",scrub:2,markers:!1}});const VM=document.querySelectorAll("#pin-hero"),WM=Rt.timeline();VM.forEach((r,e)=>{WM.to(r,{duration:4,opacity:0,ease:"power1.inOut",y:"100%",preventOverlaps:!0,scrollTrigger:{trigger:r,pin:!0,start:"bottom 20%",end:"+=50%",scrub:!0}})});const XM=document.querySelectorAll("#pin-second");XM.forEach((r,e)=>{Rt.to(r,{duration:2,opacity:0,ease:"power4.inOut",backdropFilter:"blur(20px)",scrollTrigger:{trigger:r,pin:!0,start:"top top",end:"center",scrub:!0}})});const qM=document.querySelectorAll("#pin-section");qM.forEach((r,e)=>{Rt.to(r,{duration:2,opacity:0,backdropFilter:"blur(20px)",ease:"power1.inOut",scrollTrigger:{trigger:r,pin:!0,start:"top top",end:"bottom",scrub:!0}})});const Za={x:0,y:0};window.addEventListener("mousemove",r=>{Za.x=r.clientX/pn.width-.5,Za.y=r.clientY/pn.height-.5});const YM=new tS;let Cf=0;const zp=()=>{const r=YM.getElapsedTime(),e=r-Cf;Cf=r,Ci&&(Ci.rotation.y=r*.05),Br.position.x=Math.cos(r)*.05+ct.position.x,Br.position.z=Math.sin(r)*.05+ct.position.z-5,Br.position.y=Math.sin(r)*.05+ct.position.y;const t=Za.x*.5,n=-Za.y*.5;vs.position.x+=(t-vs.position.x)*2*e,vs.position.y+=(n-vs.position.y)*2*e,Lo.render(Po,ct),window.requestAnimationFrame(zp)};zp();Rt.defaults({markers:!1});let rc=0;const Un=document.body;document.addEventListener("DOMContentLoaded",function(){const r=document.getElementById("contact-form"),e=document.getElementById("overlay"),t=document.getElementsByClassName("close-btn");document.querySelectorAll("#opn-contact").forEach(function(i){i.addEventListener("click",function(s){s.preventDefault(),r.style.display="block",e.style.display="block",document.body.classList.add("no-scroll")})}),Array.from(t).forEach(function(i){i.addEventListener("click",function(s){s.preventDefault(),r.style.display="none",e.style.display="none",document.body.classList.remove("no-scroll")})}),e.addEventListener("click",function(i){i.preventDefault(),r.style.display="none",e.style.display="none",document.body.classList.remove("no-scroll")})});window.addEventListener("scroll",()=>{const r=window.scrollY,e=Math.round(r/window.innerHeight);r<=0&&(Un.classList.remove("scroll-up"),Un.classList.add("scroll-up-btn"),Un.classList.remove("scroll-down-btn")),r>rc&&!Un.classList.contains("scroll-down")&&(Un.classList.remove("scroll-up"),Un.classList.remove("scroll-up-btn"),Un.classList.add("scroll-down"),Un.classList.add("scroll-down-btn")),r<rc&&Un.classList.contains("scroll-down")&&(Un.classList.remove("scroll-down"),Un.classList.remove("scroll-down-btn"),Un.classList.add("scroll-up"),Un.classList.add("scroll-up-btn")),rc=r,e==2&&Rt.fromTo(".a",{backdropFilter:"blur(10px)",backgroundColor:"linear-gradient(90deg, rgba(0, 0, 0, 0.1), rgba(255, 255, 255, 0))",duration:1,delay:3},{backdropFilter:"none",backgroundColor:"none"})});const $M=Rt.timeline();$M.from(".navbar",{top:"-30%",duration:2});Rt.from(".logo",{scale:0,x:"5000%",rotate:"150%",duration:2.5});Rt.from(".content-frame",{backdropFilter:"blur(20px)",duration:2});Rt.to(".marquee__part",{xPercent:-100,repeat:-1,duration:5,ease:"linear"});
//# sourceMappingURL=index-9c9caa87.js.map
