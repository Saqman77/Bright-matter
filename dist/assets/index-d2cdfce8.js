...
void main() {
	...
	#include <fog_fragment>
		...
		`,blending:er,depthTest:!1,depthWrite:!1})}function wh(){return new Gr({name:"EquirectangularToCubeUV",uniforms:{envMap:{value:null}},vertexShader:$c(),fragmentShader:`
		...
		`,blending:er,depthTest:!1,depthWrite:!1})}function Ah(){return new Gr({name:"CubemapToCubeUV",uniforms:{envMap:{value:null},flipEnvMap:{value:-1}},vertexShader:$c(),fragmentShader:`
...
`].filter(Ks).join(`
`)),a=gc(a),a=Oh(a,t),a=Fh(a,t),o=gc(o),o=Oh(o,t),o=Fh(o,t),a=zh(a),o=zh(o),t.isWebGL2&&t.isRawShaderMaterial!==!0&&(M=`#version 300 es
