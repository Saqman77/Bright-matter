...
// node_modules/intl-tel-input/build/js/intlTelInputWithUtils.js
var require_intlTelInputWithUtils = __commonJS({
  "node_modules/intl-tel-input/build/js/intlTelInputWithUtils.js"(exports, module) {
    (function(factory) {
        ...
        var Iti = class {
          ...
          _initTelInputListeners() {
            ...
            this._handleInputEvent = (e) => {
              if (this.isAndroid && (e == null ? void 0 : e.data) === "+" && separateDialCode) {
        ...
        (function() {
          ...
          J.prototype.format = function(a, b) {
            ...
            null != e && (g = e, e = w(g, 2), f = new RegExp(r(g, 1)), w(
              g,
              5
            ), g = w(g, 4), d = 2 == b && null != g && 0 < g.length ? d.replace(f, e.replace(Ta, g)) : d.replace(f, e), 3 == b && (d = d.replace(RegExp("^[-x‐-―−ー－-／  ­​⁠　()（）［］.\\[\\]/~⁓∼～]+"), ""), d = d.replace(RegExp("[-x‐-―−ー－-／  ­​⁠　()（）［］.\\[\\]/~⁓∼～]+", "g"), "-")));
            return $a(c, b, d, a);
          };
          function Q(a, b, c) {
          ...
          function V(a, b, c, d) {
            ...
            if (2 == d)
              if (Ya(T(c, 0)))
                a = T(c, 1), Ya(a) && (f = f.concat(0 == x(a, 9) ? u(r(c, 1), 9) : u(a, 9)), f.sort(), 0 == e.length ? e = u(a, 10) : (e = e.concat(u(a, 10)), e.sort()));
              else
                return V(a, b, c, 1);
            if (-1 == f[0])
              return 5;
          ...
          function eb(a, b, c, d, e, f) {
            ...
            if (0 == h.length)
              ...
              h = h.replace(K, ""), D(b), b.g(Wa(h)), g = 1;
            else {
              h = new RegExp(g);
              Xa(b);
              g = b.toString();
            ...
            if (null != c && (g = w(c, 10), h = "" + g, l = b.toString(), 0 == l.lastIndexOf(h, 0) && (h = new C(l.substring(h.length)), l = r(c, 1), l = new RegExp(w(l, 2)), fb(h, c, null), h = h.toString(), !M(l, b.toString()) && M(l, h) || 3 == V(a, b.toString(), c, -1))))
          ...
          function mb(a) {
            for (var b = a.j.length, c = 0; c < b; ++c) {
              ...
              if (f)
                return a.da = e, a.ha = lb.test(r(d, 4)), a.$ = 0, true;
            }
            return a.u = false;
          }
          function nb(a, b) {
            ...
            if (!a.u) {
              if (!a.la) {
                if (pb(a)) {
                  if (qb(a))
                    return rb(a);
                } else if (0 < a.o.length && (b = a.g.toString(), D(a.g), a.g.g(a.o), a.g.g(b), b = a.h.toString(), c = b.lastIndexOf(a.o), D(a.h), a.h.g(b.substring(0, c))), a.o != sb(a))
                  return a.h.g(" "), rb(a);
              }
              return a.s.toString();
            }
            switch (a.ba.h.length) {
              ...
              case 3:
                if (pb(a))
                  ...
                  return a.o = sb(a), tb(a);
              default:
                if (a.ea)
                  return qb(a) && (a.ea = false), a.h.toString() + a.g.toString();
                if (0 < a.j.length) {
                  b = ub(a, b);
                  c = vb(a);
                  if (0 < c.length)
          ...
          function vb(a) {
            for (var b = a.g.toString(), c = a.j.length, d = 0; d < c; ++d) {
              var e = a.j[d], f = w(e, 1);
              if (new RegExp("^(?:" + f + ")$").test(b) && (a.ha = lb.test(r(e, 4)), e = b.replace(new RegExp(f, "g"), r(e, 2)), e = Y(a, e), N(e, Ga) == a.ba))
                return e;
            }
            return "";
          }
...
export default require_intlTelInputWithUtils();
//# sourceMappingURL=intl-tel-input_intlTelInputWithUtils.js.map
