...
import startingImageTexture from './assets/particles/8.png';
import subImageTexture from './assets/particles/4.png';
...
const startTexture = loader.load(startingImageTexture);
const subTexture = loader.load(subImageTexture);
