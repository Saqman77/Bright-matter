...
const startTexture = loader.load('assets/textures/particles/8.png')
const subTexture = loader.load('assets/textures/particles/4.png')
...
for (let i = 0; i < workerCount; i++) {
    const worker = new Worker('/assets/generateGalaxyWorker.js');
    workers.push(worker);
}
